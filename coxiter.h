...
class CoxIter
{
	...
	public:
		...
		*/
		 ...
		 * 
		 * 	\param graphsProductsCount( vector< map<vector< vector<short unsigned int> >, unsigned int> >* ) Pointeur vers le vecteur de résultats (typiquement graphsProductsCount_spherical ou graphsProductsCount_euclidean)
		 */
	...
	private:
		 ...
		 * 	\param graphsProductsCount( vector< map<vector< vector<short unsigned int> >, unsigned int> >* ) Pointeur vers la liste des graphes à considérer (i.e. graphsProductsCount_spherical ou graphsProductsCount_euclidean)
