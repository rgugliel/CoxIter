...
#if defined(LONG_MAX) && defined(INTMAX_MAX) && INTMAX_MAX != LONG_MAX &&      \
    (INTMAX_MAX != LLONG_MAX || !defined(MPIRXX_HAVE_LLONG))
#define MPIRXX_INTMAX_T 1
#endif
#if defined(ULONG_MAX) && defined(UINTMAX_MAX) && UINTMAX_MAX != ULONG_MAX &&  \
    (UINTMAX_MAX != ULLONG_MAX || !defined(MPIRXX_HAVE_LLONG))
...
inline mpir_ui __gmpxx_abs_ui(mpir_si l) {
  return l >= 0 ? static_cast<mpir_ui>(l) : -static_cast<mpir_ui>(l);
}
...
struct __gmp_binary_plus {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_add(z, w, v); }
  ...
  static void eval(mpz_ptr z, mpir_ui l, mpz_srcptr w) { eval(z, w, l); }
  ...
  static void eval(mpz_ptr z, mpir_si l, mpz_srcptr w) { eval(z, w, l); }
  static void eval(mpz_ptr z, mpz_srcptr w, double d) {
    __GMPXX_TMPZ_D;
    mpz_add(z, w, temp);
  }
  static void eval(mpz_ptr z, double d, mpz_srcptr w) { eval(z, w, d); }

  static void eval(mpq_ptr q, mpq_srcptr r, mpq_srcptr s) { mpq_add(q, r, s); }
  ...
  static void eval(mpq_ptr q, mpir_ui l, mpq_srcptr r) { eval(q, r, l); }
  static inline void eval(mpq_ptr q, mpq_srcptr r, mpir_si l);
  // defined after __gmp_binary_minus
  static void eval(mpq_ptr q, mpir_si l, mpq_srcptr r) { eval(q, r, l); }
  ...
  static void eval(mpq_ptr q, double d, mpq_srcptr r) { eval(q, r, d); }
  ...
  static void eval(mpq_ptr q, mpz_srcptr z, mpq_srcptr r) { eval(q, r, z); }

  static void eval(mpf_ptr f, mpf_srcptr g, mpf_srcptr h) { mpf_add(f, g, h); }

  static void eval(mpf_ptr f, mpf_srcptr g, mpir_ui l) { mpf_add_ui(f, g, l); }
  static void eval(mpf_ptr f, mpir_ui l, mpf_srcptr g) { mpf_add_ui(f, g, l); }
  ...
  static void eval(mpf_ptr f, mpir_si l, mpf_srcptr g) { eval(f, g, l); }
  ...
  static void eval(mpf_ptr f, double d, mpf_srcptr g) { eval(f, g, d); }
};

struct __gmp_binary_minus {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_sub(z, w, v); }
  ...
  static void eval(mpq_ptr q, mpq_srcptr r, mpq_srcptr s) { mpq_sub(q, r, s); }
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, mpf_srcptr h) { mpf_sub(f, g, h); }

  static void eval(mpf_ptr f, mpf_srcptr g, mpir_ui l) { mpf_sub_ui(f, g, l); }
  static void eval(mpf_ptr f, mpir_ui l, mpf_srcptr g) { mpf_ui_sub(f, l, g); }
  static void eval(mpf_ptr f, mpf_srcptr g, mpir_si l) {
    if (l >= 0)
      mpf_sub_ui(f, g, l);
    else
...
inline void __gmp_binary_plus::eval(mpq_ptr q, mpq_srcptr r, mpir_si l) {
  if (l >= 0)
    eval(q, r, static_cast<mpir_ui>(l));
  else
...
struct __gmp_binary_multiplies {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_mul(z, w, v); }
...
// gcc-3.3 doesn't have __builtin_ctzl. Don't bother optimizing for old gcc.
  ...
  static void eval(mpq_ptr q, mpq_srcptr r, mpq_srcptr s) { mpq_mul(q, r, s); }
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, mpf_srcptr h) { mpf_mul(f, g, h); }

  static void eval(mpf_ptr f, mpf_srcptr g, mpir_ui l) { mpf_mul_ui(f, g, l); }
  static void eval(mpf_ptr f, mpir_ui l, mpf_srcptr g) { mpf_mul_ui(f, g, l); }
  static void eval(mpf_ptr f, mpf_srcptr g, mpir_si l) {
    if (l >= 0)
      mpf_mul_ui(f, g, l);
    else {
...
struct __gmp_binary_divides {
  ...
  static void eval(mpq_ptr q, mpq_srcptr r, mpq_srcptr s) { mpq_div(q, r, s); }
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, mpf_srcptr h) { mpf_div(f, g, h); }

  static void eval(mpf_ptr f, mpf_srcptr g, mpir_ui l) { mpf_div_ui(f, g, l); }
  static void eval(mpf_ptr f, mpir_ui l, mpf_srcptr g) { mpf_ui_div(f, l, g); }
  static void eval(mpf_ptr f, mpf_srcptr g, mpir_si l) {
    if (l >= 0)
      mpf_div_ui(f, g, l);
    else {
...
struct __gmp_binary_and {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_and(z, w, v); }
...
struct __gmp_binary_ior {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_ior(z, w, v); }
  static void eval(mpz_ptr z, mpz_srcptr w, mpir_ui l) {
    __GMPXX_TMPZ_UI;
    mpz_ior(z, w, temp);
  }
...
struct __gmp_binary_xor {
  static void eval(mpz_ptr z, mpz_srcptr w, mpz_srcptr v) { mpz_xor(z, w, v); }
  static void eval(mpz_ptr z, mpz_srcptr w, mpir_ui l) {
    __GMPXX_TMPZ_UI;
    mpz_xor(z, w, temp);
  }
...
struct __gmp_binary_equal {
  ...
  static bool eval(mpz_srcptr z, mpir_ui l) { return mpz_cmp_ui(z, l) == 0; }
  static bool eval(mpir_ui l, mpz_srcptr z) { return mpz_cmp_ui(z, l) == 0; }
  static bool eval(mpz_srcptr z, mpir_si l) { return mpz_cmp_si(z, l) == 0; }
  static bool eval(mpir_si l, mpz_srcptr z) { return mpz_cmp_si(z, l) == 0; }
  static bool eval(mpz_srcptr z, double d) { return mpz_cmp_d(z, d) == 0; }
  static bool eval(double d, mpz_srcptr z) { return mpz_cmp_d(z, d) == 0; }

  static bool eval(mpq_srcptr q, mpq_srcptr r) { return mpq_equal(q, r) != 0; }

  static bool eval(mpq_srcptr q, mpir_ui l) { return mpq_cmp_ui(q, l, 1) == 0; }
  static bool eval(mpir_ui l, mpq_srcptr q) { return mpq_cmp_ui(q, l, 1) == 0; }
  static bool eval(mpq_srcptr q, mpir_si l) { return mpq_cmp_si(q, l, 1) == 0; }
  static bool eval(mpir_si l, mpq_srcptr q) { return mpq_cmp_si(q, l, 1) == 0; }
  ...
  static bool eval(double d, mpq_srcptr q) { return eval(q, d); }

  static bool eval(mpf_srcptr f, mpf_srcptr g) { return mpf_cmp(f, g) == 0; }

  static bool eval(mpf_srcptr f, mpir_ui l) { return mpf_cmp_ui(f, l) == 0; }
  static bool eval(mpir_ui l, mpf_srcptr f) { return mpf_cmp_ui(f, l) == 0; }
  static bool eval(mpf_srcptr f, mpir_si l) { return mpf_cmp_si(f, l) == 0; }
  static bool eval(mpir_si l, mpf_srcptr f) { return mpf_cmp_si(f, l) == 0; }
  static bool eval(mpf_srcptr f, double d) { return mpf_cmp_d(f, d) == 0; }
  static bool eval(double d, mpf_srcptr f) { return mpf_cmp_d(f, d) == 0; }
};
...
struct __gmp_hypot_function {
  ...
  static void eval(mpf_ptr f, mpir_ui l, mpf_srcptr g) { eval(f, g, l); }
  static void eval(mpf_ptr f, mpf_srcptr g, mpir_si l) {
    mpf_t temp;
    mpf_init2(temp, mpf_get_prec(f));
    mpf_mul(temp, g, g);
...
struct __gmp_cmp_function {
  ...
  static int eval(mpz_srcptr z, mpir_ui l) { return mpz_cmp_ui(z, l); }
  static int eval(mpir_ui l, mpz_srcptr z) { return -mpz_cmp_ui(z, l); }
  static int eval(mpz_srcptr z, mpir_si l) { return mpz_cmp_si(z, l); }
  static int eval(mpir_si l, mpz_srcptr z) { return -mpz_cmp_si(z, l); }
  static int eval(mpz_srcptr z, double d) { return mpz_cmp_d(z, d); }
  static int eval(double d, mpz_srcptr z) { return -mpz_cmp_d(z, d); }

  static int eval(mpq_srcptr q, mpq_srcptr r) { return mpq_cmp(q, r); }

  static int eval(mpq_srcptr q, mpir_ui l) { return mpq_cmp_ui(q, l, 1); }
  static int eval(mpir_ui l, mpq_srcptr q) { return -mpq_cmp_ui(q, l, 1); }
  static int eval(mpq_srcptr q, mpir_si l) { return mpq_cmp_si(q, l, 1); }
  static int eval(mpir_si l, mpq_srcptr q) { return -mpq_cmp_si(q, l, 1); }
  ...
  static int eval(mpf_srcptr f, mpir_ui l) { return mpf_cmp_ui(f, l); }
  static int eval(mpir_ui l, mpf_srcptr f) { return -mpf_cmp_ui(f, l); }
  static int eval(mpf_srcptr f, mpir_si l) { return mpf_cmp_si(f, l); }
  static int eval(mpir_si l, mpf_srcptr f) { return -mpf_cmp_si(f, l); }
  static int eval(mpf_srcptr f, double d) { return mpf_cmp_d(f, d); }
  static int eval(double d, mpf_srcptr f) { return -mpf_cmp_d(f, d); }
};
...
template <class T> struct __gmp_resolve_ref { typedef T ref_type; };

template <class T, class U> struct __gmp_resolve_ref<__gmp_expr<T, U>> {
  typedef const __gmp_expr<T, U> &ref_type;
};

template <class T, class U = T> struct __gmp_resolve_expr;

template <> struct __gmp_resolve_expr<mpz_t> {
  typedef mpz_t value_type;
  typedef mpz_ptr ptr_type;
  typedef mpz_srcptr srcptr_type;
};

template <> struct __gmp_resolve_expr<mpq_t> {
  typedef mpq_t value_type;
  typedef mpq_ptr ptr_type;
  typedef mpq_srcptr srcptr_type;
};

template <> struct __gmp_resolve_expr<mpf_t> {
  typedef mpf_t value_type;
  typedef mpf_ptr ptr_type;
  typedef mpf_srcptr srcptr_type;
};

template <> struct __gmp_resolve_expr<mpz_t, mpq_t> {
  typedef mpq_t value_type;
};

template <> struct __gmp_resolve_expr<mpq_t, mpz_t> {
  typedef mpq_t value_type;
};

template <> struct __gmp_resolve_expr<mpz_t, mpf_t> {
  typedef mpf_t value_type;
};

template <> struct __gmp_resolve_expr<mpf_t, mpz_t> {
  typedef mpf_t value_type;
};

template <> struct __gmp_resolve_expr<mpq_t, mpf_t> {
  typedef mpf_t value_type;
};

template <> struct __gmp_resolve_expr<mpf_t, mpq_t> {
  typedef mpf_t value_type;
};
...
#define __GMPXX_DECLARE_COMMON_TYPE(typ)                                       \
  template <class T, class U> struct common_type<__gmp_expr<T, U>, typ> {      \
    typedef __gmp_expr<T, T> type;                                             \
  };                                                                           \
                                                                               \
  template <class T, class U> struct common_type<typ, __gmp_expr<T, U>> {      \
    typedef __gmp_expr<T, T> type;                                             \
  }
...
template <class T, class Op> struct __gmp_unary_expr {
  const T &val;
...
template <class T, class U, class Op> struct __gmp_binary_expr {
...
public:
...
#endif
  template <class T> __gmp_expr(const __gmp_expr<mpz_t, T> &expr) {
    mpz_init(mp);
...
#ifdef MPIRXX_HAVE_LLONG
  __gmp_expr &operator=(signed long long int i) {
    mpz_set_si(mp, i);
    return *this;
  }
  __gmp_expr &operator=(unsigned long long int i) {
    mpz_set_ui(mp, i);
    return *this;
  }
#endif
...
#ifdef MPIRXX_INTMAX_T
  __gmp_expr &operator=(intmax_t i) {
    mpz_set_sx(mp, i);
    return *this;
  }
#endif
...
#ifdef MPIRXX_UINTMAX_T
  __gmp_expr &operator=(uintmax_t i) {
    mpz_set_ux(mp, i);
    return *this;
  }
#endif
  ...
  int set_str(const char *s, int base) { return mpz_set_str(mp, s, base); }
...
template <> class __gmp_expr<mpq_t, mpq_t> {
private:
  typedef mpq_t value_type;
  value_type mp;
...
public:
  ...
  template <class T> __gmp_expr(const __gmp_expr<mpq_t, T> &expr) {
    mpq_init(mp);
    __gmp_set_expr(mp, expr);
  }
  template <class T, class U>
...
#ifdef MPIRXX_HAVE_LLONG
  __gmp_expr(signed long long int l) {
    mpq_init(mp);
    mpq_set_si(mp, l, 1);
  }
  __gmp_expr(unsigned long long int l) {
    mpq_init(mp);
    mpq_set_ui(mp, l, 1);
  }
#endif
  ...
  // string input/output functions
  int set_str(const char *s, int base) { return mpq_set_str(mp, s, base); }
  int set_str(const std::string &s, int base) {
...
public:
  ...
  __gmp_expr(const __gmp_expr &f) {
    mpf_init2(mp, f.get_prec());
    mpf_set(mp, f.mp);
  }
#if __GMPXX_USE_CXX11 || defined(MSC_CXX_11)
  __gmp_expr(__gmp_expr &&f) {
    *mp = *f.mp;
    mpf_init2(f.mp, get_prec());
  }
#endif
  ...
  template <class T, class U> __gmp_expr(const __gmp_expr<T, U> &expr) {
    mpf_init2(mp, expr.get_prec());
    __gmp_set_expr(mp, expr);
  }
  template <class T, class U>
  ...
  // string input/output functions
  int set_str(const char *s, int base) { return mpf_set_str(mp, s, base); }
  int set_str(const std::string &s, int base) {
...
#if __GMPXX_USE_CXX11
inline mpz_class operator"" _mpz(const char *s) { return mpz_class(s); }
...
inline mpf_class operator"" _mpf(const char *s) { return mpf_class(s); }
#endif
...
template <class T, class U>
inline std::ostream &operator<<(std::ostream &o, const __gmp_expr<T, U> &expr) {
...
template <class T> class __gmp_temp {
  __gmp_expr<T, T> val;

public:
  template <class U, class V> __gmp_temp(U const &u, V) : val(u) {}
  typename __gmp_resolve_expr<T>::srcptr_type __get_mp() const {
    return val.__get_mp();
  }
};

template <> class __gmp_temp<mpf_t> {
  mpf_class val;
...
public:
  ...
  mp_bitcnt_t get_prec() const {
    mp_bitcnt_t prec1 = expr.val1.get_prec(), prec2 = expr.val2.get_prec();
...
#define __GMPZQ_DEFINE_EXPR(eval_fun)                                          \
  ...
  public:                                                                      \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }            \
                                                                               ...
                                                                               \
  template <class T, class U>                                                  \
  class __gmp_expr<mpq_t, __gmp_binary_expr<__gmp_expr<mpz_t, T>,              \
                                            __gmp_expr<mpq_t, U>, eval_fun>> { \
  private:                                                                     \
    typedef __gmp_expr<mpz_t, T> val1_type;                                    \
  ...
  public:                                                                      \
    ...
    mp_bitcnt_t get_prec() const { return mpf_get_default_prec(); }            \
                                                                               ...
                                                                               \
  template <class T, class U>                                                  \
  class __gmp_expr<mpq_t, __gmp_binary_expr<__gmp_expr<mpq_t, T>,              \
                                            __gmp_expr<mpz_t, U>, eval_fun>> { \
  private:                                                                     \
    typedef __gmp_expr<mpq_t, T> val1_type;                                    \
...
#define __GMP_DEFINE_UNARY_FUNCTION(fun, eval_fun)                             \
                                                                               \
  template <class T, class U>                                                  \
  inline __gmp_expr<T, __gmp_unary_expr<__gmp_expr<T, U>, eval_fun>> fun(      \
...
#define __GMP_DEFINE_UNARY_TYPE_FUNCTION(type, fun, eval_fun)                  \
                                                                               \
  template <class T, class U> inline type fun(const __gmp_expr<T, U> &expr) {  \
    __gmp_expr<T, T> const &temp(expr);                                        \
...
#define __GMPNN_DEFINE_BINARY_FUNCTION(fun, eval_fun, type, bigtype)           \
                                                                               \
  template <class T, class U>                                                  \
  inline __gmp_expr<T, __gmp_binary_expr<__gmp_expr<T, U>, bigtype, eval_fun>> \
  fun(const __gmp_expr<T, U> &expr, type t) {                                  \
    return __gmp_expr<T,                                                       \
                      __gmp_binary_expr<__gmp_expr<T, U>, bigtype, eval_fun>>( \
        expr, t);                                                              \
  }                                                                            \
                                                                               \
  template <class T, class U>                                                  \
  inline __gmp_expr<T, __gmp_binary_expr<bigtype, __gmp_expr<T, U>, eval_fun>> \
  fun(type t, const __gmp_expr<T, U> &expr) {                                  \
    return __gmp_expr<T,                                                       \
                      __gmp_binary_expr<bigtype, __gmp_expr<T, U>, eval_fun>>( \
        t, expr);                                                              \
  }
...
#define __GMP_DEFINE_BINARY_FUNCTION_UI(fun, eval_fun)                         \
  ...
  fun(const __gmp_expr<T, U> &expr, mp_bitcnt_t l) {                           \
    return __gmp_expr<T,                                                       \
                      __gmp_binary_expr<__gmp_expr<T, U>, mpir_ui, eval_fun>>( \
        expr, l);                                                              \
  }
...
#define __GMPNN_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2,        \
                                            bigtype)                           \
                                                                               \
  template <class T, class U>                                                  \
...
#define __GMPNS_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2)        \
  __GMPNN_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2, mpir_si)

#define __GMPNU_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2)        \
  __GMPNN_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun, type2, mpir_ui)
...
#define __GMPN_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun)                \
  ...
  __GMPNS_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun,                     \
                                      signed long long int)                    \
  __GMPNU_DEFINE_BINARY_TYPE_FUNCTION(type, fun, eval_fun,                     \
...
#define __GMPP_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun)                   \
  ...
  inline type##_class &type##_class::fun(const __gmp_expr<T, U> &expr) {       \
    __gmp_set_expr(                                                            \
        mp,                                                                    \
        __gmp_expr<type##_t, __gmp_binary_expr<type##_class, __gmp_expr<T, U>, \
                                               eval_fun>>(*this, expr));       \
    return *this;                                                              \
  }
...
#define __GMPNN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2, bigtype)  \
  ...
  inline type##_class &type##_class::fun(type2 t) {                            \
    __gmp_set_expr(                                                            \
        mp, __gmp_expr<type##_t,                                               \
                       __gmp_binary_expr<type##_class, bigtype, eval_fun>>(    \
                *this, t));                                                    \
    return *this;                                                              \
  }

#define __GMPNS_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2)           \
  __GMPNN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2, mpir_si)

#define __GMPNU_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2)           \
  __GMPNN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun, type2, mpir_ui)
...
#define __GMPN_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun)                   \
  ...
  __GMPNU_DEFINE_COMPOUND_OPERATOR(type, fun, eval_fun,                        \
                                   unsigned long long int)                     \
...
#define __GMP_DEFINE_COMPOUND_OPERATOR_UI(type, fun, eval_fun)                 \
  ...
  inline type##_class &type##_class::fun(mpir_ui l) {                          \
    __gmp_set_expr(                                                            \
        mp, __gmp_expr<type##_t,                                               \
                       __gmp_binary_expr<type##_class, mpir_ui, eval_fun>>(    \
                *this, l));                                                    \
    return *this;                                                              \
  }
...
template <> class __gmp_expr<mpz_t, __gmp_urandomb_value> {
private:
...
template <> class __gmp_expr<mpz_t, __gmp_urandomm_value> {
private:
  __gmp_randstate_struct *state;
  mpz_class range;
...
template <> class __gmp_expr<mpf_t, __gmp_urandomb_value> {
private:
  __gmp_randstate_struct *state;
  mp_bitcnt_t bits;
...
public:
  ...
  void eval(mpf_ptr f) const {
    __gmp_rand_function::eval(f, state, (bits > 0) ? bits : mpf_get_prec(f));
  }
  mp_bitcnt_t get_prec() const {
    if (bits == 0)
...
typedef void __gmp_randinit_lc_2exp_t(gmp_randstate_t, mpz_srcptr, mpir_ui,
                                      mp_bitcnt_t);
...
public:
  ...
  gmp_randclass(__gmp_randinit_lc_2exp_t *f, mpz_class z, mpir_ui l1,
                mp_bitcnt_t l2) {
    f(state, z.get_mpz_t(), l1, l2);
  }

  // gmp_randinit_lc_2exp_size
  gmp_randclass(__gmp_randinit_lc_2exp_size_t *f, mp_bitcnt_t size) {
    if (f(state, size) == 0)
