...
#define DECL_add_err1_n(name)                                                  \
  mp_limb_t name __GMP_PROTO(                                                  \
      (mp_ptr, mp_srcptr, mp_srcptr, mp_ptr, mp_srcptr, mp_size_t, mp_limb_t))
#define DECL_add_err2_n(name)                                                  \
  mp_limb_t name __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr, mp_ptr, mp_srcptr, \
...
#define DECL_copyd(name) void name __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t))
#define DECL_copyi(name) void name __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t))
...
#define DECL_preinv_divrem_1(name)                                             \
  mp_limb_t name __GMP_PROTO(                                                  \
      (mp_ptr, mp_size_t, mp_srcptr, mp_size_t, mp_limb_t, mp_limb_t, int))
...
static const mp_limb_t sq_res_0x100[8] = {
    CNST_LIMB(0x2030213), CNST_LIMB(0x2020212), CNST_LIMB(0x2020213),
    CNST_LIMB(0x2020212), CNST_LIMB(0x2030212), CNST_LIMB(0x2020212),
    CNST_LIMB(0x2020212), CNST_LIMB(0x2020212),
};
...
#define PERFSQR_MOD_TEST(up, usize)                                            \
  do {                                                                         \
    ...
    PERFSQR_MOD_34(r, up, usize);                                              \
                                                                               \
    /* 73.33% */                                                               \
    PERFSQR_MOD_2(r, CNST_LIMB(45), CNST_LIMB(0xfa4fa5), CNST_LIMB(0x920),     \
                  CNST_LIMB(0x1a442481));                                      \
                                                                               \
    /* 47.06% */                                                               \
    PERFSQR_MOD_1(r, CNST_LIMB(17), CNST_LIMB(0xf0f0f1), CNST_LIMB(0x1a317));  \
                                                                               \
    /* 46.15% */                                                               \
    PERFSQR_MOD_1(r, CNST_LIMB(13), CNST_LIMB(0xec4ec5), CNST_LIMB(0x9e5));    \
                                                                               \
    /* 42.86% */                                                               \
    PERFSQR_MOD_1(r, CNST_LIMB(7), CNST_LIMB(0xdb6db7), CNST_LIMB(0x69));      \
  } while (0)

/* Grand total sq_res_0x100 and PERFSQR_MOD_TEST, 99.25% non-squares. */

/* helper for tests/mpz/t-perfsqr.c */
#define PERFSQR_DIVISORS                                                       \
  { 256, 45, 17, 13, 7, }
...
/* Non-zero bit indicates a quadratic residue mod 0x100.
   This test identifies 82.81% as non-squares (212/256). */
static const mp_limb_t sq_res_0x100[4] = {
...
/* "const" basically means a function does nothing but examine its arguments
   ...
   this off when trying to write timing loops.  */
    ...
    !(defined(__cplusplus) && defined(__sun))
...
__GMP_DECLSPEC void *__gmp_tmp_reentrant_alloc
    _PROTO((struct tmp_reentrant_t **, size_t)) ATTRIBUTE_MALLOC;
...
#define TMP_ALLOC(n) (LIKELY((n) < 65536) ? TMP_SALLOC(n) : TMP_BALLOC(n))
#define TMP_SFREE
#define TMP_FREE                                                               \
  do {                                                                         \
...
__GMP_DECLSPEC void __gmp_tmp_debug_mark _PROTO((const char *, int,
                                                 struct tmp_debug_t **,
                                                 struct tmp_debug_t *,
                                                 const char *, const char *));
__GMP_DECLSPEC void *
    __gmp_tmp_debug_alloc _PROTO((const char *, int, int, struct tmp_debug_t **,
...
#define TMP_MARK_NAME(marker, marker_name)                                     \
  do {                                                                         \
    ...
    __gmp_tmp_debug_mark(ASSERT_FILE, ASSERT_LINE, &__tmp_marker,              \
                         &__tmp_marker_struct, __tmp_marker_name,              \
                         marker_name);                                         \
  } while (0)
#define TMP_SALLOC(n) TMP_ALLOC(n)
#define TMP_BALLOC(n) TMP_ALLOC(n)
#define TMP_ALLOC(size)                                                        \
  __gmp_tmp_debug_alloc(ASSERT_FILE, ASSERT_LINE, __tmp_marker_inscope,        \
                        &__tmp_marker, __tmp_marker_name, size)
#define TMP_FREE_NAME(marker, marker_name)                                     \
  do {                                                                         \
    __gmp_tmp_debug_free(ASSERT_FILE, ASSERT_LINE, marker, &__tmp_marker,      \
...
#define USHRT_HIGHBIT                                                          \
  ((unsigned short)(USHRT_MAX ^ ((unsigned short)USHRT_MAX >> 1)))
...
__GMP_DECLSPEC extern void *(*__gmp_reallocate_func)__GMP_PROTO((void *, size_t,
                                                                 size_t));
...
#define __GMP_REALLOCATE_FUNC_MAYBE_TYPE(ptr, oldsize, newsize, type)          \
  do {                                                                         \
    if ((oldsize) != (newsize))                                                \
      (ptr) = (type *)(*__gmp_reallocate_func)(ptr, (oldsize) * sizeof(type),  \
                                               (newsize) * sizeof(type));      \
  } while (0)
...
__GMP_DECLSPEC void __gmpz_aorsmul_1
    _PROTO((REGPARM_3_1(mpz_ptr w, mpz_srcptr u, mp_limb_t v, mp_size_t sub)))
        REGPARM_ATTR(1);
#define mpz_aorsmul_1(w, u, v, sub) __gmpz_aorsmul_1(REGPARM_3_1(w, u, v, sub))

#define mpz_n_pow_ui __gmpz_n_pow_ui
__GMP_DECLSPEC void mpz_n_pow_ui _PROTO((mpz_ptr, mp_srcptr, mp_size_t,
                                         mpir_ui));

#define mpn_add_nc __MPN(add_nc)
__GMP_DECLSPEC mp_limb_t mpn_add_nc __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                 mp_size_t, mp_limb_t));

#define mpn_addmul_1c __MPN(addmul_1c)
__GMP_DECLSPEC mp_limb_t mpn_addmul_1c __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_size_t, mp_limb_t,
                                                    mp_limb_t));

#define mpn_addmul_2 __MPN(addmul_2)
__GMP_DECLSPEC mp_limb_t mpn_addmul_2 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addmul_3 __MPN(addmul_3)
__GMP_DECLSPEC mp_limb_t mpn_addmul_3 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addmul_4 __MPN(addmul_4)
__GMP_DECLSPEC mp_limb_t mpn_addmul_4 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addmul_5 __MPN(addmul_5)
__GMP_DECLSPEC mp_limb_t mpn_addmul_5 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addmul_6 __MPN(addmul_6)
__GMP_DECLSPEC mp_limb_t mpn_addmul_6 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addmul_7 __MPN(addmul_7)
__GMP_DECLSPEC mp_limb_t mpn_addmul_7 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addmul_8 __MPN(addmul_8)
__GMP_DECLSPEC mp_limb_t mpn_addmul_8 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                              mp_srcptr));

#define mpn_addlsh_n __MPN(addlsh_n)
__GMP_DECLSPEC mp_limb_t mpn_addlsh_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                   mp_size_t, unsigned int));

#define mpn_sublsh_n __MPN(sublsh_n)
__GMP_DECLSPEC mp_limb_t mpn_sublsh_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                   mp_size_t, unsigned int));

#define mpn_addlsh_nc __MPN(addlsh_nc)
__GMP_DECLSPEC mp_limb_t mpn_addlsh_nc __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t,
                                                    unsigned int, mp_limb_t));

#define mpn_sublsh_nc __MPN(sublsh_nc)
__GMP_DECLSPEC mp_limb_t mpn_sublsh_nc __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t,
                                                    unsigned int, mp_limb_t));
...
__GMP_DECLSPEC mp_limb_t mpn_rsh1add_n __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t));
...
__GMP_DECLSPEC mp_limb_t mpn_rsh1sub_n __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t));

#if HAVE_NATIVE_mpn_lshiftc
#define mpn_lshiftc __MPN(lshiftc)
__GMP_DECLSPEC mp_limb_t mpn_lshiftc __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                  unsigned int));
#endif

#define mpn_addadd_n __MPN(addadd_n)
__GMP_DECLSPEC mp_limb_t mpn_addadd_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                   mp_srcptr, mp_size_t));

#define mpn_addsub_n __MPN(addsub_n)
__GMP_DECLSPEC int mpn_addsub_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                             mp_srcptr, mp_size_t));

#define mpn_subadd_n __MPN(subadd_n)
__GMP_DECLSPEC mp_limb_t mpn_subadd_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                   mp_srcptr, mp_size_t));
...
__GMP_DECLSPEC mp_limb_t mpn_sumdiff_n __GMP_PROTO((mp_ptr, mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t));
#endif

#define mpn_sumdiff_nc __MPN(sumdiff_nc)
__GMP_DECLSPEC mp_limb_t mpn_sumdiff_nc __GMP_PROTO((mp_ptr, mp_ptr, mp_srcptr,
                                                     mp_srcptr, mp_size_t,
                                                     mp_limb_t));

#define mpn_divexact_byff __MPN(divexact_byff)
__GMP_DECLSPEC mp_limb_t mpn_divexact_byff __GMP_PROTO((mp_ptr, mp_srcptr,
                                                        mp_size_t));

#ifndef mpn_divexact_byfobm1 /* if not done with cpuvec in a fat binary */
#define mpn_divexact_byfobm1 __MPN(divexact_byfobm1)
__GMP_DECLSPEC mp_limb_t mpn_divexact_byfobm1 __GMP_PROTO((mp_ptr, mp_srcptr,
                                                           mp_size_t, mp_limb_t,
                                                           mp_limb_t));
#endif
...
__GMP_DECLSPEC mp_limb_t mpn_add_err1_n(mp_ptr, mp_srcptr, mp_srcptr, mp_ptr,
                                        mp_srcptr, mp_size_t, mp_limb_t);
#endif

#ifndef mpn_sub_err1_n /* if not done with cpuvec in a fat binary */
#define mpn_sub_err1_n __MPN(sub_err1_n)
__GMP_DECLSPEC mp_limb_t mpn_sub_err1_n(mp_ptr, mp_srcptr, mp_srcptr, mp_ptr,
                                        mp_srcptr, mp_size_t, mp_limb_t);
#endif

#ifndef mpn_add_err2_n /* if not done with cpuvec in a fat binary */
#define mpn_add_err2_n __MPN(add_err2_n)
__GMP_DECLSPEC mp_limb_t mpn_add_err2_n(mp_ptr, mp_srcptr, mp_srcptr, mp_ptr,
...
__GMP_DECLSPEC mp_limb_t mpn_sub_err2_n(mp_ptr, mp_srcptr, mp_srcptr, mp_ptr,
                                        mp_srcptr, mp_srcptr, mp_size_t,
                                        mp_limb_t);
#endif

#define mpn_divrem_1c __MPN(divrem_1c)
__GMP_DECLSPEC mp_limb_t mpn_divrem_1c __GMP_PROTO((mp_ptr, mp_size_t,
                                                    mp_srcptr, mp_size_t,
                                                    mp_limb_t, mp_limb_t));
...
__GMP_DECLSPEC int mpn_jacobi_base _PROTO((mp_limb_t a, mp_limb_t b,
                                           int result_bit1)) ATTRIBUTE_CONST;
...
__GMP_DECLSPEC mp_limb_t mpn_mod_1c __GMP_PROTO(
    (mp_srcptr, mp_size_t, mp_limb_t, mp_limb_t)) __GMP_ATTRIBUTE_PURE;

#define mpn_mul_1c __MPN(mul_1c)
__GMP_DECLSPEC mp_limb_t mpn_mul_1c __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                 mp_limb_t, mp_limb_t));
...
__GMP_DECLSPEC void mpn_mul_basecase __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                  mp_srcptr, mp_size_t));
#endif

#define mpn_mullow_n __MPN(mullow_n)
__GMP_DECLSPEC void mpn_mullow_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                              mp_size_t));

#define mpn_mullow_n_basecase __MPN(mullow_n_basecase)
__GMP_DECLSPEC void mpn_mullow_n_basecase __GMP_PROTO((mp_ptr, mp_srcptr,
                                                       mp_srcptr, mp_size_t));

#define mpn_mulhigh_n __MPN(mulhigh_n)
__GMP_DECLSPEC void mpn_mulhigh_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                               mp_size_t));

#define mpn_mullow_basecase __MPN(mullow_basecase)
__GMP_DECLSPEC void mpn_mullow_basecase __GMP_PROTO((mp_ptr, mp_srcptr,
                                                     mp_size_t, mp_srcptr,
                                                     mp_size_t, mp_size_t));

#ifndef mpn_mulmid_basecase /* if not done with cpuvec in a fat binary */
#define mpn_mulmid_basecase __MPN(mulmid_basecase)
__GMP_DECLSPEC void mpn_mulmid_basecase __GMP_PROTO((mp_ptr, mp_srcptr,
                                                     mp_size_t, mp_srcptr,
                                                     mp_size_t));
#endif

#define mpn_mod_1_1 __MPN(mod_1_1)
__GMP_DECLSPEC void mpn_mod_1_1 __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                             mp_srcptr));

#define mpn_mod_1_2 __MPN(mod_1_2)
__GMP_DECLSPEC void mpn_mod_1_2 __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                             mp_srcptr));

#define mpn_mod_1_3 __MPN(mod_1_3)
__GMP_DECLSPEC void mpn_mod_1_3 __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                             mp_srcptr));

#define mpn_mod_1_k __MPN(mod_1_k)
__GMP_DECLSPEC mp_limb_t mpn_mod_1_k __GMP_PROTO((mp_srcptr, mp_size_t,
                                                  mp_limb_t, mp_size_t));

#define mpn_mulmid __MPN(mulmid)
__GMP_DECLSPEC void mpn_mulmid __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                            mp_srcptr, mp_size_t));

#define mpn_mulmid_n __MPN(mulmid_n)
__GMP_DECLSPEC void mpn_mulmid_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                              mp_size_t));

#ifndef mpn_sqr_basecase /* if not done with cpuvec in a fat binary */
#define mpn_sqr_basecase __MPN(sqr_basecase)
__GMP_DECLSPEC void mpn_sqr_basecase __GMP_PROTO((mp_ptr, mp_srcptr,
                                                  mp_size_t));
#endif

#define mpz_trial_division __gmpz_trial_division
__GMP_DECLSPEC unsigned long
    mpz_trial_division __GMP_PROTO((mpz_srcptr, unsigned long, unsigned long));

#define mpn_sub_nc __MPN(sub_nc)
__GMP_DECLSPEC mp_limb_t mpn_sub_nc __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                 mp_size_t, mp_limb_t));

#define mpn_submul_1c __MPN(submul_1c)
__GMP_DECLSPEC mp_limb_t mpn_submul_1c __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_size_t, mp_limb_t,
                                                    mp_limb_t));

#define mpn_invert_2exp __MPN(invert_2exp)
__GMP_DECLSPEC void mpn_invert_2exp __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                 mp_ptr));
...
__GMP_DECLSPEC void mpn_invert_trunc __GMP_PROTO((mp_ptr, mp_size_t, mp_srcptr,
                                                  mp_size_t, mp_srcptr));
...
__GMP_DECLSPEC mp_limb_t mpn_divrem_euclidean_qr_1
...
__GMP_DECLSPEC mp_limb_t mpn_divrem_euclidean_qr_2 __GMP_PROTO((mp_ptr, mp_ptr,
                                                                mp_size_t,
                                                                mp_srcptr));
#endif

#define mpn_divrem_euclidean_r_1 __MPN(divrem_euclidean_r_1)
__GMP_DECLSPEC mp_limb_t mpn_divrem_euclidean_r_1 __GMP_PROTO((mp_srcptr,
                                                               mp_size_t,
                                                               mp_limb_t));

#define mpn_divrem_hensel_qr_1 __MPN(divrem_hensel_qr_1)
__GMP_DECLSPEC mp_limb_t mpn_divrem_hensel_qr_1 __GMP_PROTO((mp_ptr, mp_srcptr,
                                                             mp_size_t,
                                                             mp_limb_t));

#define mpn_divrem_hensel_qr_1_1 __MPN(divrem_hensel_qr_1_1)
__GMP_DECLSPEC mp_limb_t mpn_divrem_hensel_qr_1_1
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t));

#define mpn_divrem_hensel_qr_1_2 __MPN(divrem_hensel_qr_1_2)
__GMP_DECLSPEC mp_limb_t mpn_divrem_hensel_qr_1_2
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t));

#define mpn_divrem_hensel_rsh_qr_1_preinv __MPN(divrem_hensel_rsh_qr_1_preinv)
__GMP_DECLSPEC mp_limb_t mpn_divrem_hensel_rsh_qr_1_preinv
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t, mp_limb_t, int));

#define mpn_divrem_hensel_rsh_qr_1 __MPN(divrem_hensel_rsh_qr_1)
__GMP_DECLSPEC mp_limb_t mpn_divrem_hensel_rsh_qr_1
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t, int));

#define mpn_rsh_divrem_hensel_qr_1 __MPN(rsh_divrem_hensel_qr_1)
__GMP_DECLSPEC mp_limb_t mpn_rsh_divrem_hensel_qr_1
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t, int, mp_limb_t));

#define mpn_rsh_divrem_hensel_qr_1_1 __MPN(rsh_divrem_hensel_qr_1_1)
__GMP_DECLSPEC mp_limb_t mpn_rsh_divrem_hensel_qr_1_1
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t, int, mp_limb_t));

#define mpn_rsh_divrem_hensel_qr_1_2 __MPN(rsh_divrem_hensel_qr_1_2)
__GMP_DECLSPEC mp_limb_t mpn_rsh_divrem_hensel_qr_1_2
    __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t, int, mp_limb_t));

#define mpn_divrem_hensel_r_1 __MPN(divrem_hensel_r_1)
__GMP_DECLSPEC mp_limb_t mpn_divrem_hensel_r_1 __GMP_PROTO((mp_srcptr,
                                                            mp_size_t,
                                                            mp_limb_t));
...
#define mpn_addmod_2expp1_1(r, limbs, c)                                       \
  do {                                                                         \
    ...
    if ((mp_limb_signed_t)(__sum ^ (r)[0]) >= 0)                               \
      ...
      if ((mp_limb_signed_t)(c) >= 0)                                          \
        mpn_add_1((r), (r), (limbs) + 1, (mp_limb_signed_t)(c));               \
      else                                                                     \
        mpn_sub_1((r), (r), (limbs) + 1, -(mp_limb_signed_t)(c));              \
    }                                                                          \
  } while (0)

#define mpn_mul_2expmod_2expp1 __MPN(mul_2expmod_2expp1)
__GMP_DECLSPEC void mpn_mul_2expmod_2expp1 __GMP_PROTO((mp_ptr t, mp_ptr i1,
                                                        mp_size_t limbs,
                                                        mp_bitcnt_t d));

#define mpir_revbin __mpir_revbin
__GMP_DECLSPEC mp_limb_t mpir_revbin __GMP_PROTO((mp_limb_t in,
                                                  mp_limb_t bits));
...
__GMP_DECLSPEC void mpir_fft_combine_bits
    __GMP_PROTO((mp_ptr res, const mp_ptr *poly, long length, mp_bitcnt_t bits,
                 mp_size_t output_limbs, mp_size_t total_limbs));

#define mpir_fft_split_bits __mpir_fft_split_bits
__GMP_DECLSPEC mp_size_t mpir_fft_split_bits
    __GMP_PROTO((mp_ptr * poly, mp_srcptr limbs, mp_size_t total_limbs,
...
__GMP_DECLSPEC void mpir_fft_adjust __GMP_PROTO((mp_ptr r, mp_ptr i1,
                                                 mp_size_t i, mp_size_t limbs,
                                                 mp_bitcnt_t w));

#define mpir_fft_adjust_sqrt2 __mpir_fft_adjust_sqrt2
__GMP_DECLSPEC void mpir_fft_adjust_sqrt2
    __GMP_PROTO((mp_ptr r, mp_ptr i1, mp_size_t i, mp_size_t limbs,
                 mp_bitcnt_t w, mp_ptr temp));

#define mpir_butterfly_lshB __mpir_butterfly_lshB
__GMP_DECLSPEC void mpir_butterfly_lshB __GMP_PROTO((mp_ptr t, mp_ptr u,
                                                     mp_ptr i1, mp_ptr i2,
                                                     mp_size_t limbs,
                                                     mp_size_t x, mp_size_t y));

#define mpir_butterfly_rshB __mpir_butterfly_rshB
__GMP_DECLSPEC void mpir_butterfly_rshB __GMP_PROTO((mp_ptr t, mp_ptr u,
                                                     mp_ptr i1, mp_ptr i2,
                                                     mp_size_t limbs,
                                                     mp_size_t x, mp_size_t y));

#define mpir_fermat_to_mpz __fermat_to_mpz
__GMP_DECLSPEC void mpir_fermat_to_mpz __GMP_PROTO((mpz_t m, mp_ptr i,
                                                    mp_size_t limbs));

#define mpir_fft_butterfly_twiddle __mpir_fft_butterfly_twiddle
__GMP_DECLSPEC void mpir_fft_butterfly_twiddle
    __GMP_PROTO((mp_ptr u, mp_ptr v, mp_ptr s, mp_ptr t, mp_size_t limbs,
                 mp_bitcnt_t b1, mp_bitcnt_t b2));

#define mpir_ifft_butterfly_twiddle __mpir_ifft_butterfly_twiddle
__GMP_DECLSPEC void mpir_ifft_butterfly_twiddle
    __GMP_PROTO((mp_ptr u, mp_ptr v, mp_ptr s, mp_ptr t, mp_size_t limbs,
                 mp_bitcnt_t b1, mp_bitcnt_t b2));

#define mpir_fft_butterfly_sqrt2 __mpir_fft_butterfly_sqrt2
__GMP_DECLSPEC void mpir_fft_butterfly_sqrt2
    __GMP_PROTO((mp_ptr s, mp_ptr t, mp_ptr i1, mp_ptr i2, mp_size_t i,
                 mp_size_t limbs, mp_bitcnt_t w, mp_ptr temp));

#define mpir_ifft_butterfly_sqrt2 __mpir_ifft_butterfly_sqrt2
__GMP_DECLSPEC void mpir_ifft_butterfly_sqrt2
    __GMP_PROTO((mp_ptr s, mp_ptr t, mp_ptr i1, mp_ptr i2, mp_size_t i,
                 mp_size_t limbs, mp_bitcnt_t w, mp_ptr temp));

#define mpir_fft_butterfly __mpir_fft_butterfly
__GMP_DECLSPEC void mpir_fft_butterfly
    __GMP_PROTO((mp_ptr s, mp_ptr t, mp_ptr i1, mp_ptr i2, mp_size_t i,
                 mp_size_t limbs, mp_bitcnt_t w));

#define mpir_ifft_butterfly __mpir_ifft_butterfly
__GMP_DECLSPEC void mpir_ifft_butterfly
    __GMP_PROTO((mp_ptr s, mp_ptr t, mp_ptr i1, mp_ptr i2, mp_size_t i,
                 mp_size_t limbs, mp_bitcnt_t w));

#define mpir_fft_combine_limbs __combine_limbs
__GMP_DECLSPEC void mpir_fft_combine_limbs __GMP_PROTO(
    (mp_ptr res, const mp_ptr *poly, long length, mp_size_t coeff_limbs,
     mp_size_t output_limbs, mp_size_t total_limbs));

#define mpir_fft_split_limbs __mpir_fft_split_limbs
__GMP_DECLSPEC mp_size_t mpir_fft_split_limbs
    __GMP_PROTO((mp_ptr * poly, mp_srcptr limbs, mp_size_t total_limbs,
                 mp_size_t coeff_limbs, mp_size_t output_limbs));

#define mpir_fft_radix2 __mpir_fft_radix2
__GMP_DECLSPEC void mpir_fft_radix2 __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                 mp_bitcnt_t w, mp_ptr *t1,
                                                 mp_ptr *t2));
...
__GMP_DECLSPEC void mpir_fft_trunc __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                mp_bitcnt_t w, mp_ptr *t1,
                                                mp_ptr *t2, mp_size_t trunc));

#define mpir_ifft_trunc __mpir_ifft_trunc
__GMP_DECLSPEC void mpir_ifft_trunc __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                 mp_bitcnt_t w, mp_ptr *t1,
                                                 mp_ptr *t2, mp_size_t trunc));

#define mpir_fft_trunc_sqrt2 __mpir_fft_trunc_sqrt2
__GMP_DECLSPEC void mpir_fft_trunc_sqrt2 __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                      mp_bitcnt_t w, mp_ptr *t1,
                                                      mp_ptr *t2, mp_ptr *temp,
                                                      mp_size_t trunc));

#define mpir_ifft_trunc_sqrt2 __mpir_ifft_trunc_sqrt2
__GMP_DECLSPEC void mpir_ifft_trunc_sqrt2
    __GMP_PROTO((mp_ptr * ii, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
                 mp_ptr *t2, mp_ptr *temp, mp_size_t trunc));

#define mpir_fft_mfa_trunc_sqrt2 __mpir_fft_mfa_trunc_sqrt2
__GMP_DECLSPEC void mpir_fft_mfa_trunc_sqrt2
    __GMP_PROTO((mp_ptr * ii, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
                 mp_ptr *t2, mp_ptr *temp, mp_size_t n1, mp_size_t trunc));

#define mpir_ifft_mfa_trunc_sqrt2 __mpir_ifft_mfa_trunc_sqrt2
__GMP_DECLSPEC void mpir_ifft_mfa_trunc_sqrt2
    __GMP_PROTO((mp_ptr * ii, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
                 mp_ptr *t2, mp_ptr *temp, mp_size_t n1, mp_size_t trunc));

#define mpir_fft_negacyclic __mpir_fft_negacyclic
__GMP_DECLSPEC void mpir_fft_negacyclic __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                     mp_bitcnt_t w, mp_ptr *t1,
                                                     mp_ptr *t2, mp_ptr *temp));

#define mpir_ifft_negacyclic __mpir_ifft_negacyclic
__GMP_DECLSPEC void
    mpir_ifft_negacyclic __GMP_PROTO((mp_ptr * ii, mp_size_t n, mp_bitcnt_t w,
                                      mp_ptr *t1, mp_ptr *t2, mp_ptr *temp));

#define mpir_fft_mfa_trunc_sqrt2_outer __mpir_fft_mfa_trunc_sqrt2_outer
__GMP_DECLSPEC void mpir_fft_mfa_trunc_sqrt2_outer
    __GMP_PROTO((mp_ptr * ii, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
                 mp_ptr *t2, mp_ptr *temp, mp_size_t n1, mp_size_t trunc));

#define mpir_ifft_mfa_trunc_sqrt2_outer __mpir_ifft_mfa_trunc_sqrt2_outer
__GMP_DECLSPEC void mpir_ifft_mfa_trunc_sqrt2_outer
    __GMP_PROTO((mp_ptr * ii, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
                 mp_ptr *t2, mp_ptr *temp, mp_size_t n1, mp_size_t trunc));

#define mpir_fft_mfa_trunc_sqrt2_inner __mpir_fft_mfa_trunc_sqrt2_inner
__GMP_DECLSPEC void mpir_fft_mfa_trunc_sqrt2_inner __GMP_PROTO(
    (mp_ptr * ii, mp_ptr *jj, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
     mp_ptr *t2, mp_ptr *temp, mp_size_t n1, mp_size_t trunc, mp_ptr tt));

#define mpir_fft_mulmod_2expp1 __mpir_fft_mulmod_2expp1
__GMP_DECLSPEC void mpir_fft_mulmod_2expp1(mp_ptr r1, mp_srcptr i1,
                                           mp_srcptr i2, mp_size_t r_limbs,
                                           mp_bitcnt_t depth, mp_bitcnt_t w);

#define mpir_fft_trunc1 __mpir_fft_trunc1
__GMP_DECLSPEC void mpir_fft_trunc1 __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                 mp_bitcnt_t w, mp_ptr *t1,
                                                 mp_ptr *t2, mp_size_t trunc));

#define mpir_ifft_trunc1 __mpir_ifft_trunc1
__GMP_DECLSPEC void mpir_ifft_trunc1 __GMP_PROTO((mp_ptr * ii, mp_size_t n,
                                                  mp_bitcnt_t w, mp_ptr *t1,
                                                  mp_ptr *t2, mp_size_t trunc));

#define mpir_fft_radix2_twiddle __mpir_fft_radix2_twiddle
__GMP_DECLSPEC void mpir_fft_radix2_twiddle __GMP_PROTO(
    (mp_ptr * ii, mp_size_t is, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
     mp_ptr *t2, mp_size_t ws, mp_size_t r, mp_size_t c, mp_size_t rs));

#define mpir_ifft_radix2_twiddle __mpir_ifft_radix2_twiddle
__GMP_DECLSPEC void mpir_ifft_radix2_twiddle __GMP_PROTO(
    (mp_ptr * ii, mp_size_t is, mp_size_t n, mp_bitcnt_t w, mp_ptr *t1,
     mp_ptr *t2, mp_size_t ws, mp_size_t r, mp_size_t c, mp_size_t rs));

#define mpir_fft_trunc1_twiddle __mpir_fft_trunc1_twiddle
__GMP_DECLSPEC void mpir_fft_trunc1_twiddle
    __GMP_PROTO((mp_ptr * ii, mp_size_t is, mp_size_t n, mp_bitcnt_t w,
                 mp_ptr *t1, mp_ptr *t2, mp_size_t ws, mp_size_t r, mp_size_t c,
                 mp_size_t rs, mp_size_t trunc));

#define mpir_ifft_trunc1_twiddle __mpir_ifft_trunc1_twiddle
__GMP_DECLSPEC void mpir_ifft_trunc1_twiddle
    __GMP_PROTO((mp_ptr * ii, mp_size_t is, mp_size_t n, mp_bitcnt_t w,
                 mp_ptr *t1, mp_ptr *t2, mp_size_t ws, mp_size_t r, mp_size_t c,
                 mp_size_t rs, mp_size_t trunc));

#define mpir_fft_naive_convolution_1 __mpir_fft_naive_convolution_1
__GMP_DECLSPEC void mpir_fft_naive_convolution_1
    __GMP_PROTO((mp_ptr r, mp_srcptr ii, mp_srcptr jj, mp_size_t m));

#define mpn_mulmod_2expp1_basecase __MPN(mulmod_2expp1_basecase)
__GMP_DECLSPEC int mpn_mulmod_2expp1_basecase __GMP_PROTO((mp_ptr, mp_srcptr,
                                                           mp_srcptr, int,
                                                           mpir_ui, mp_ptr));
...
__GMP_DECLSPEC void mpn_div_2expmod_2expp1 __GMP_PROTO((mp_ptr t, mp_srcptr i1,
                                                        mp_size_t limbs,
                                                        mp_bitcnt_t d));

#define mpn_mul_trunc_sqrt2 __MPN(mul_trunc_sqrt2)
__GMP_DECLSPEC void mpn_mul_trunc_sqrt2
    __GMP_PROTO((mp_ptr r1, mp_srcptr i1, mp_size_t n1, mp_srcptr i2,
                 mp_size_t n2, mp_bitcnt_t depth, mp_bitcnt_t w));

#define mpn_mul_mfa_trunc_sqrt2 __MPN(mul_mfa_trunc_sqrt2)
__GMP_DECLSPEC void mpn_mul_mfa_trunc_sqrt2
    __GMP_PROTO((mp_ptr r1, mp_srcptr i1, mp_size_t n1, mp_srcptr i2,
                 mp_size_t n2, mp_bitcnt_t depth, mp_bitcnt_t w));
...
typedef struct {
  ...
  void(*randget_fn)
      __GMP_PROTO((gmp_randstate_t rstate, mp_ptr dest, mpir_ui nbits));
...
#define _gmp_rand(rp, state, bits)                                             \
  do {                                                                         \
    ...
    (*((gmp_randfnptr_t *)RNG_FNPTR(__rstate))->randget_fn)(__rstate, rp,      \
                                                            bits);             \
  } while (0)
...
__GMP_DECLSPEC void mpn_kara_mul_n _PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                           mp_size_t, mp_ptr));

#define mpn_kara_sqr_n __MPN(kara_sqr_n)
__GMP_DECLSPEC void mpn_kara_sqr_n _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                           mp_ptr));

#define mpn_toom3_mul_n __MPN(toom3_mul_n)
__GMP_DECLSPEC void mpn_toom3_mul_n _PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t, mp_ptr));

#define mpn_toom3_mul __MPN(toom3_mul)
__GMP_DECLSPEC void mpn_toom3_mul _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                          mp_srcptr, mp_size_t, mp_ptr));

#define mpn_toom3_interpolate __MPN(toom3_interpolate)
__GMP_DECLSPEC void mpn_toom3_interpolate
    _PROTO((mp_ptr c, mp_ptr v1, mp_ptr v2, mp_ptr vm1, mp_ptr vinf,
            mp_size_t k, mp_size_t rr2, int sa, mp_limb_t vinf0, mp_ptr ws));

#define mpn_toom32_mul __MPN(toom32_mul)
__GMP_DECLSPEC void mpn_toom32_mul _PROTO((mp_ptr c, mp_srcptr a, mp_size_t an,
                                           mp_srcptr b, mp_size_t bn,
                                           mp_ptr t));

#define mpn_toom42_mul __MPN(toom42_mul)
__GMP_DECLSPEC void mpn_toom42_mul _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                           mp_srcptr, mp_size_t, mp_ptr));

#define mpn_toom4_mul_n __MPN(toom4_mul_n)
__GMP_DECLSPEC void mpn_toom4_mul_n _PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t));

#define mpn_toom4_mul __MPN(toom4_mul)
__GMP_DECLSPEC void mpn_toom4_mul _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                          mp_srcptr, mp_size_t));

#define mpn_toom53_mul __MPN(toom53_mul)
__GMP_DECLSPEC void mpn_toom53_mul _PROTO((mp_ptr rp, mp_srcptr up,
                                           mp_size_t un, mp_srcptr vp,
                                           mp_size_t vn));

#define mpn_toom4_interpolate __MPN(toom4_interpolate)
__GMP_DECLSPEC void mpn_toom4_interpolate _PROTO((mp_ptr rp, mp_size_t *rpn,
                                                  mp_size_t sn, mp_ptr tp,
                                                  mp_size_t s4, mp_size_t n4,
                                                  mp_size_t n6, mp_limb_t r30));
...
__GMP_DECLSPEC int mpn_toom_eval_pm2exp _PROTO((mp_ptr xp2, mp_ptr xm2,
                                                unsigned k, mp_srcptr xp,
                                                mp_size_t n, mp_size_t hn,
                                                unsigned shift, mp_ptr tp));

#define mpn_toom_eval_pm2rexp __MPN(toom_eval_pm2rexp)
__GMP_DECLSPEC int mpn_toom_eval_pm2rexp _PROTO((mp_ptr rp, mp_ptr rm,
                                                 unsigned int q, mp_srcptr ap,
                                                 mp_size_t n, mp_size_t t,
                                                 unsigned int s, mp_ptr ws));

#define mpn_toom_interpolate_16pts __MPN(toom_interpolate_16pts)
__GMP_DECLSPEC void mpn_toom_interpolate_16pts
    _PROTO((mp_ptr pp, mp_ptr r1, mp_ptr r3, mp_ptr r5, mp_ptr r7, mp_size_t n,
            mp_size_t spt, int half, mp_ptr wsi));

#define mpn_toom_couple_handling __MPN(toom_couple_handling)
__GMP_DECLSPEC void
    mpn_toom_couple_handling _PROTO((mp_ptr pp, mp_size_t n, mp_ptr np,
                                     int nsign, mp_size_t off, int ps, int ns));

#define mpn_toom8h_mul __MPN(toom8h_mul)
__GMP_DECLSPEC void mpn_toom8h_mul _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                           mp_srcptr, mp_size_t));

#define mpn_toom3_sqr_n __MPN(toom3_sqr_n)
__GMP_DECLSPEC void mpn_toom3_sqr_n _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                            mp_ptr));
...
__GMP_DECLSPEC void mpn_toom42_mulmid __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                   mp_size_t, mp_ptr));
...
/* void mpn_tdiv_q _PROTO ((mp_ptr, mp_size_t, mp_srcptr, mp_size_t, mp_srcptr,
 * mp_size_t)); */

#define mpz_divexact_gcd __gmpz_divexact_gcd
__GMP_DECLSPEC void mpz_divexact_gcd _PROTO((mpz_ptr q, mpz_srcptr a,
                                             mpz_srcptr d));
...
__GMP_DECLSPEC size_t mpz_inp_str_nowhite _PROTO((mpz_ptr x, FILE *stream,
                                                  int base, int c,
                                                  size_t nread));
#endif
...
__GMP_DECLSPEC int
    mpn_divisible_p _PROTO((mp_srcptr ap, mp_size_t asize, mp_srcptr dp,
                            mp_size_t dsize)) __GMP_ATTRIBUTE_PURE;

#define mpn_rootrem __MPN(rootrem)
__GMP_DECLSPEC mp_size_t mpn_rootrem _PROTO((mp_ptr, mp_ptr, mp_srcptr,
                                             mp_size_t, mp_limb_t));

#define mpn_rootrem_basecase __MPN(rootrem_basecase)
__GMP_DECLSPEC mp_size_t mpn_rootrem_basecase _PROTO((mp_ptr, mp_ptr, mp_srcptr,
                                                      mp_size_t, mp_limb_t));
...
#define MPZ_REALLOC(z, n)                                                      \
  (UNLIKELY((n) > ALLOC(z)) ? (mp_ptr)_mpz_realloc(z, n) : PTR(z))
...
__GMP_DECLSPEC void __gmp_assert_header _PROTO((const char *filename,
                                                int linenum));
__GMP_DECLSPEC void __gmp_assert_fail _PROTO(
    (const char *filename, int linenum, const char *expr)) ATTRIBUTE_NORETURN;
...
__GMP_DECLSPEC mp_limb_t mpn_addlsh1_n __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t));
#elif HAVE_NATIVE_mpn_addlsh_n
#define mpn_addlsh1_n(__xp, __yp, __zp, __n)                                   \
  mpn_addlsh_n((__xp), (__yp), (__zp), (__n), 1)
#define HAVE_NATIVE_mpn_addlsh1_n 1
#endif

#if HAVE_NATIVE_mpn_sublsh1_n
#define mpn_sublsh1_n __MPN(sublsh1_n)
__GMP_DECLSPEC mp_limb_t mpn_sublsh1_n __GMP_PROTO((mp_ptr, mp_srcptr,
                                                    mp_srcptr, mp_size_t));
#elif HAVE_NATIVE_mpn_sublsh_n
#define mpn_sublsh1_n(__xp, __yp, __zp, __n)                                   \
  mpn_sublsh_n((__xp), (__yp), (__zp), (__n), 1)
#define HAVE_NATIVE_mpn_sublsh1_n 1
#endif

#if HAVE_NATIVE_mpn_inclsh_n
#define mpn_inclsh_n __MPN(inclsh_n)
__GMP_DECLSPEC mp_limb_t mpn_inclsh_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                   unsigned int));
#elif HAVE_NATIVE_mpn_addlsh_n
#define mpn_inclsh_n(__xp, __yp, __n, __c)                                     \
  mpn_addlsh_n((__xp), (__xp), (__yp), (__n), (__c))
#define HAVE_NATIVE_mpn_inclsh_n 1
#endif

#if HAVE_NATIVE_mpn_declsh_n
#define mpn_declsh_n __MPN(declsh_n)
__GMP_DECLSPEC mp_limb_t mpn_declsh_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                   unsigned int));
#elif HAVE_NATIVE_mpn_sublsh_n
#define mpn_declsh_n(__xp, __yp, __n, __c)                                     \
  mpn_sublsh_n((__xp), (__xp), (__yp), (__n), (__c))
  ...
  do {                                                                         \
    ...
    if ((size) == 0)                                                           \
      ...
      if (POW2_P(base)) {                                                      \
        ...
        (result) =                                                             \
            (size_t)(__totbits * mp_bases[base].chars_per_bit_exactly) + 1;    \
    }                                                                          \
  } while (0)
...
#define invert_pi1(dinv, d1, d0) mpir_invert_pi1((dinv).inv32, d1, d0)
...
__GMP_DECLSPEC mp_limb_t mpn_preinv_divrem_1 _PROTO(
    (mp_ptr, mp_size_t, mp_srcptr, mp_size_t, mp_limb_t, mp_limb_t, int));
#endif
...
__GMP_DECLSPEC mp_limb_t mpn_mod_34lsub1 _PROTO((mp_srcptr, mp_size_t))
...
__GMP_DECLSPEC void mpn_divexact_1 _PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                           mp_limb_t));
#endif
...
__GMP_DECLSPEC mp_limb_t mpn_modexact_1c_odd
    _PROTO((mp_srcptr src, mp_size_t size, mp_limb_t divisor,
            mp_limb_t c)) __GMP_ATTRIBUTE_PURE;
#endif

#if HAVE_NATIVE_mpn_modexact_1_odd
#define mpn_modexact_1_odd __MPN(modexact_1_odd)
__GMP_DECLSPEC mp_limb_t mpn_modexact_1_odd _PROTO(
    (mp_srcptr src, mp_size_t size, mp_limb_t divisor)) __GMP_ATTRIBUTE_PURE;
#else
...
#define BSWAP_LIMB(dst, src)                                                   \
  do {                                                                         \
    (dst) = ((src) << 24) + (((src)&0xFF00) << 8) + (((src) >> 8) & 0xFF00) +  \
            ((src) >> 24);                                                     \
  } while (0)
#endif
...
#define BSWAP_LIMB(dst, src)                                                   \
  do {                                                                         \
    (dst) = ((src) << 56) + (((src)&0xFF00) << 40) +                           \
            (((src)&0xFF0000) << 24) + (((src)&0xFF000000) << 8) +             \
            (((src) >> 8) & 0xFF000000) + (((src) >> 24) & 0xFF0000) +         \
            (((src) >> 40) & 0xFF00) + ((src) >> 56);                          \
  } while (0)
#endif
#endif
...
__GMP_DECLSPEC double mpn_get_d __GMP_PROTO((mp_srcptr, mp_size_t, mp_size_t,
                                             long)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC void mpn_matrix22_mul
    __GMP_PROTO((mp_ptr, mp_ptr, mp_ptr, mp_ptr, mp_size_t, mp_srcptr,
                 mp_srcptr, mp_srcptr, mp_srcptr, mp_size_t, mp_ptr));
#define mpn_matrix22_mul_strassen __MPN(matrix22_mul_strassen)
__GMP_DECLSPEC void mpn_matrix22_mul_strassen
    __GMP_PROTO((mp_ptr, mp_ptr, mp_ptr, mp_ptr, mp_size_t, mp_srcptr,
                 mp_srcptr, mp_srcptr, mp_srcptr, mp_size_t, mp_ptr));
#define mpn_matrix22_mul_itch __MPN(matrix22_mul_itch)
__GMP_DECLSPEC mp_size_t mpn_matrix22_mul_itch __GMP_PROTO((mp_size_t,
                                                            mp_size_t));
...
__GMP_DECLSPEC int mpn_hgcd2(mp_limb_t, mp_limb_t, mp_limb_t, mp_limb_t,
                             struct hgcd_matrix1 *);

#define mpn_hgcd_mul_matrix1_vector __MPN(hgcd_mul_matrix1_vector)
__GMP_DECLSPEC mp_size_t mpn_hgcd_mul_matrix1_vector(
...
__GMP_DECLSPEC mp_size_t mpn_matrix22_mul1_inverse_vector(
    const struct hgcd_matrix1 *, mp_ptr, mp_srcptr, mp_ptr, mp_size_t);

#define mpn_hgcd2_jacobi __MPN(hgcd2_jacobi)
__GMP_DECLSPEC int mpn_hgcd2_jacobi(mp_limb_t, mp_limb_t, mp_limb_t, mp_limb_t,
...
__GMP_DECLSPEC void mpn_hgcd_matrix_init(struct hgcd_matrix *, mp_size_t,
                                         mp_ptr);

#define mpn_hgcd_matrix_update_q __MPN(hgcd_matrix_update_q)
__GMP_DECLSPEC void mpn_hgcd_matrix_update_q(struct hgcd_matrix *, mp_srcptr,
                                             mp_size_t, unsigned, mp_ptr);

#define mpn_hgcd_matrix_mul_1 __MPN(hgcd_matrix_mul_1)
__GMP_DECLSPEC void mpn_hgcd_matrix_mul_1(struct hgcd_matrix *,
                                          const struct hgcd_matrix1 *, mp_ptr);

#define mpn_hgcd_matrix_mul __MPN(hgcd_matrix_mul)
__GMP_DECLSPEC void mpn_hgcd_matrix_mul(struct hgcd_matrix *,
                                        const struct hgcd_matrix *, mp_ptr);

#define mpn_hgcd_matrix_adjust __MPN(hgcd_matrix_adjust)
__GMP_DECLSPEC mp_size_t mpn_hgcd_matrix_adjust(const struct hgcd_matrix *,
                                                mp_size_t, mp_ptr, mp_ptr,
                                                mp_size_t, mp_ptr);

#define mpn_hgcd_step __MPN(hgcd_step)
__GMP_DECLSPEC mp_size_t mpn_hgcd_step(mp_size_t, mp_ptr, mp_ptr, mp_size_t,
                                       struct hgcd_matrix *, mp_ptr);

#define mpn_hgcd_reduce __MPN(hgcd_reduce)
__GMP_DECLSPEC mp_size_t mpn_hgcd_reduce(struct hgcd_matrix *, mp_ptr, mp_ptr,
...
__GMP_DECLSPEC mp_size_t mpn_hgcd(mp_ptr, mp_ptr, mp_size_t,
                                  struct hgcd_matrix *, mp_ptr);
...
__GMP_DECLSPEC int mpn_hgcd_appr(mp_ptr, mp_ptr, mp_size_t,
                                 struct hgcd_matrix *, mp_ptr);

#define mpn_hgcd_jacobi __MPN(hgcd_jacobi)
__GMP_DECLSPEC mp_size_t mpn_hgcd_jacobi(mp_ptr, mp_ptr, mp_size_t,
                                         struct hgcd_matrix *, unsigned *,
                                         mp_ptr);
...
__GMP_DECLSPEC mp_size_t mpn_gcd_subdiv_step(mp_ptr, mp_ptr, mp_size_t,
                                             mp_size_t, gcd_subdiv_step_hook *,
                                             void *, mp_ptr);
...
__GMP_DECLSPEC mp_size_t mpn_gcdext_lehmer_n(mp_ptr, mp_ptr, mp_size_t *,
...
__GMP_DECLSPEC void mpn_mulmod_bnm1(mp_ptr, mp_size_t, mp_srcptr, mp_size_t,
                                    mp_srcptr, mp_size_t, mp_ptr);

#define mpn_mulmod_bnm1_next_size(x)                                           \
  ((x) <= 2 * FFT_MULMOD_2EXPP1_CUTOFF                                         \
       ? (x)                                                                   \
       : 2 * mpir_fft_adjust_limbs(((x) + 1) / 2))
...
__GMP_DECLSPEC mp_size_t mpn_dc_set_str __GMP_PROTO(
    (mp_ptr, const unsigned char *, size_t, const powers_t *, mp_ptr));
#define mpn_bc_set_str __MPN(bc_set_str)
__GMP_DECLSPEC mp_size_t mpn_bc_set_str __GMP_PROTO((mp_ptr,
                                                     const unsigned char *,
                                                     size_t, int));
#define mpn_set_str_compute_powtab __MPN(set_str_compute_powtab)
__GMP_DECLSPEC void mpn_set_str_compute_powtab __GMP_PROTO((powers_t *, mp_ptr,
                                                            mp_size_t, int));
#define mpn_pre_set_str __MPN(pre_set_str)
__GMP_DECLSPEC void mpn_pre_set_str __GMP_PROTO((mp_ptr wp, unsigned char *str,
                                                 size_t str_len,
                                                 powers_t *powtab, mp_ptr tp));
...
void _tc4_add_unsigned(mp_ptr rp, mp_size_t *rn, mp_srcptr r1, mp_size_t r1n,
                       mp_srcptr r2, mp_size_t r2n);

void tc4_add_unsigned(mp_ptr rp, mp_size_t *rn, mp_srcptr r1, mp_size_t r1n,
                      mp_srcptr r2, mp_size_t r2n);

void tc4_sub(mp_ptr rp, mp_size_t *rn, mp_srcptr r1, mp_size_t r1n,
             mp_srcptr r2, mp_size_t r2n);

void tc4_lshift(mp_ptr rp, mp_size_t *rn, mp_srcptr xp, mp_size_t xn,
                mp_size_t bits);
...
void tc4_divexact_ui(mp_ptr rp, mp_size_t *rn, mp_ptr x, mp_size_t xn,
                     mp_limb_t c);
...
void tc4_addmul_1(mp_ptr wp, mp_size_t *wn, mp_srcptr xp, mp_size_t xn,
                  mp_limb_t y);

void tc4_submul_1(mp_ptr wp, mp_size_t *wn, mp_srcptr x, mp_size_t xn,
                  mp_limb_t y);

void tc4_copy(mp_ptr yp, mp_size_t *yn, mp_size_t offset, mp_srcptr xp,
              mp_size_t xn);
...
#define GMP_ASPRINTF_T_NEED(d, n)                                              \
  do {                                                                         \
    ...
    if (alloc <= newsize) {                                                    \
      newalloc = 2 * newsize;                                                  \
      (d)->alloc = newalloc;                                                   \
      (d)->buf = __GMP_REALLOCATE_FUNC_TYPE((d)->buf, alloc, newalloc, char);  \
    }                                                                          \
  } while (0)

__GMP_DECLSPEC int __gmp_asprintf_memory _PROTO((struct gmp_asprintf_t * d,
                                                 const char *str, size_t len));
__GMP_DECLSPEC int __gmp_asprintf_reps _PROTO((struct gmp_asprintf_t * d, int c,
                                               int reps));
...
#define DOPRNT_REPS(c, n) DOPRNT_ACCUMULATE_FUN(funs->reps, (data, c, n))
...
__GMP_DECLSPEC int __gmp_doprnt _PROTO((const struct doprnt_funs_t *, void *,
                                        const char *, va_list));
__GMP_DECLSPEC int
    __gmp_doprnt_integer _PROTO((const struct doprnt_funs_t *, void *,
                                 const struct doprnt_params_t *, const char *));

#define __gmp_doprnt_mpf __gmp_doprnt_mpf2
__GMP_DECLSPEC int __gmp_doprnt_mpf _PROTO((const struct doprnt_funs_t *,
                                            void *,
                                            const struct doprnt_params_t *,
                                            const char *, mpf_srcptr));

__GMP_DECLSPEC int __gmp_replacement_vsnprintf _PROTO((char *, size_t,
                                                       const char *, va_list));
...
#if _GMP_H_HAVE_VA_LIST
__GMP_DECLSPEC int __gmp_doscan _PROTO((const struct gmp_doscan_funs_t *,
...
void __gmp_istream_set_digits(std::string &, std::istream &, char &, bool &,
                              int);
void __gmp_doprnt_params_from_ios(struct doprnt_params_t *p, std::ios &o);
std::ostream &__gmp_doprnt_integer_ostream(std::ostream &o,
                                           struct doprnt_params_t *p, char *s);
