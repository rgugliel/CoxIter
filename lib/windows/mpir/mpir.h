...
/* gcc has __inline__ in all modes, including strict ansi.  Give a prototype
   ...
   case the function is called rather than inlined.  */
    ...
    (__APPLE_CC__ != 1) /* FSF GCC sets this flag to 1 on Apple machines */
...
__GMP_DECLSPEC void mp_set_memory_functions
    __GMP_PROTO((void *(*)(size_t), void *(*)(void *, size_t, size_t),
...
__GMP_DECLSPEC void gmp_randinit_set
    __GMP_PROTO((gmp_randstate_t, __gmp_const __gmp_randstate_struct *));
...
__GMP_DECLSPEC int gmp_obstack_printf __GMP_PROTO((struct obstack *,
                                                   __gmp_const char *, ...));
#endif
...
__GMP_DECLSPEC int gmp_sscanf __GMP_PROTO((__gmp_const char *,
                                           __gmp_const char *, ...));
...
#define __GMP_MPZ_ADD_UI_MIN_ALLOC(x, y, z)                                    \
  (__GMP_MAX(__GMP_ABS(y->_mp_size),                                           \
             1 + (GMP_BITS_PER_UI - 1) / GMP_NUMB_BITS) +                      \
   1)
...
__GMP_DECLSPEC void mpz_cdiv_q_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                 mp_bitcnt_t));
#define mpz_cdiv_q_ui __gmpz_cdiv_q_ui
__GMP_DECLSPEC mpir_ui mpz_cdiv_q_ui __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                  mpir_ui));
#define mpz_cdiv_qr __gmpz_cdiv_qr
__GMP_DECLSPEC void mpz_cdiv_qr __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                             mpz_srcptr));
#define mpz_cdiv_qr_ui __gmpz_cdiv_qr_ui
__GMP_DECLSPEC mpir_ui mpz_cdiv_qr_ui __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                                   mpir_ui));
#define mpz_cdiv_r __gmpz_cdiv_r
__GMP_DECLSPEC void mpz_cdiv_r __GMP_PROTO((mpz_ptr, mpz_srcptr, mpz_srcptr));
#define mpz_cdiv_r_2exp __gmpz_cdiv_r_2exp
__GMP_DECLSPEC void mpz_cdiv_r_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                 mp_bitcnt_t));
#define mpz_cdiv_r_ui __gmpz_cdiv_r_ui
__GMP_DECLSPEC mpir_ui mpz_cdiv_r_ui __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                  mpir_ui));
#define mpz_cdiv_ui __gmpz_cdiv_ui
__GMP_DECLSPEC mpir_ui mpz_cdiv_ui __GMP_PROTO((mpz_srcptr,
                                                mpir_ui)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int mpz_cmp __GMP_PROTO((mpz_srcptr, mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_cmp_d __gmpz_cmp_d
__GMP_DECLSPEC int mpz_cmp_d __GMP_PROTO((mpz_srcptr,
                                          double)) __GMP_ATTRIBUTE_PURE;
#define _mpz_cmp_si __gmpz_cmp_si
__GMP_DECLSPEC int _mpz_cmp_si __GMP_PROTO((mpz_srcptr, mpir_si))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define _mpz_cmp_ui __gmpz_cmp_ui
__GMP_DECLSPEC int _mpz_cmp_ui __GMP_PROTO((mpz_srcptr, mpir_ui))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_cmpabs __gmpz_cmpabs
__GMP_DECLSPEC int mpz_cmpabs __GMP_PROTO((mpz_srcptr, mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_cmpabs_d __gmpz_cmpabs_d
__GMP_DECLSPEC int mpz_cmpabs_d __GMP_PROTO((mpz_srcptr,
                                             double)) __GMP_ATTRIBUTE_PURE;
#define mpz_cmpabs_ui __gmpz_cmpabs_ui
__GMP_DECLSPEC int mpz_cmpabs_ui __GMP_PROTO((mpz_srcptr, mpir_ui))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int mpz_congruent_p
    __GMP_PROTO((mpz_srcptr, mpz_srcptr, mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
#define mpz_congruent_2exp_p __gmpz_congruent_2exp_p
__GMP_DECLSPEC int mpz_congruent_2exp_p __GMP_PROTO(
    (mpz_srcptr, mpz_srcptr, mp_bitcnt_t)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_congruent_ui_p __gmpz_congruent_ui_p
__GMP_DECLSPEC int mpz_congruent_ui_p
    __GMP_PROTO((mpz_srcptr, mpir_ui, mpir_ui)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int
    mpz_divisible_p __GMP_PROTO((mpz_srcptr, mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
#define mpz_divisible_ui_p __gmpz_divisible_ui_p
__GMP_DECLSPEC int
    mpz_divisible_ui_p __GMP_PROTO((mpz_srcptr, mpir_ui)) __GMP_ATTRIBUTE_PURE;
#define mpz_divisible_2exp_p __gmpz_divisible_2exp_p
__GMP_DECLSPEC int mpz_divisible_2exp_p __GMP_PROTO((mpz_srcptr, mp_bitcnt_t))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_dump __gmpz_dump
__GMP_DECLSPEC void mpz_dump __GMP_PROTO((mpz_srcptr));
#define mpz_export __gmpz_export
__GMP_DECLSPEC void *mpz_export __GMP_PROTO((void *, size_t *, int, size_t, int,
                                             size_t, mpz_srcptr));
...
__GMP_DECLSPEC void mpz_fdiv_q_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                 mp_bitcnt_t));
#define mpz_fdiv_q_ui __gmpz_fdiv_q_ui
__GMP_DECLSPEC mpir_ui mpz_fdiv_q_ui __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                  mpir_ui));
#define mpz_fdiv_qr __gmpz_fdiv_qr
__GMP_DECLSPEC void mpz_fdiv_qr __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                             mpz_srcptr));
#define mpz_fdiv_qr_ui __gmpz_fdiv_qr_ui
__GMP_DECLSPEC mpir_ui mpz_fdiv_qr_ui __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                                   mpir_ui));
#define mpz_fdiv_r __gmpz_fdiv_r
__GMP_DECLSPEC void mpz_fdiv_r __GMP_PROTO((mpz_ptr, mpz_srcptr, mpz_srcptr));
#define mpz_fdiv_r_2exp __gmpz_fdiv_r_2exp
__GMP_DECLSPEC void mpz_fdiv_r_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                 mp_bitcnt_t));
#define mpz_fdiv_r_ui __gmpz_fdiv_r_ui
__GMP_DECLSPEC mpir_ui mpz_fdiv_r_ui __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                  mpir_ui));
#define mpz_fdiv_ui __gmpz_fdiv_ui
__GMP_DECLSPEC mpir_ui mpz_fdiv_ui __GMP_PROTO((mpz_srcptr,
                                                mpir_ui)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int mpz_fits_sint_p __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_fits_si_p __gmpz_fits_si_p
__GMP_DECLSPEC int
    mpz_fits_si_p __GMP_PROTO((mpz_srcptr)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_fits_slong_p __gmpz_fits_slong_p
__GMP_DECLSPEC int mpz_fits_slong_p __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_fits_sshort_p __gmpz_fits_sshort_p
__GMP_DECLSPEC int mpz_fits_sshort_p __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_fits_uint_p __gmpz_fits_uint_p
#if __GMP_INLINE_PROTOTYPES || defined(__GMP_FORCE_mpz_fits_uint_p)
__GMP_DECLSPEC int mpz_fits_uint_p __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#endif
#define mpz_fits_ui_p __gmpz_fits_ui_p
#if __GMP_INLINE_PROTOTYPES || defined(__GMP_FORCE_mpz_fits_ui_p)
__GMP_DECLSPEC int
    mpz_fits_ui_p __GMP_PROTO((mpz_srcptr)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#endif
#define mpz_fits_ulong_p __gmpz_fits_ulong_p
#if __GMP_INLINE_PROTOTYPES || defined(__GMP_FORCE_mpz_fits_ulong_p)
__GMP_DECLSPEC int mpz_fits_ulong_p __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#endif
#define mpz_fits_ushort_p __gmpz_fits_ushort_p
#if __GMP_INLINE_PROTOTYPES || defined(__GMP_FORCE_mpz_fits_ushort_p)
__GMP_DECLSPEC int mpz_fits_ushort_p __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#endif
...
__GMP_DECLSPEC /* signed */ mpir_si mpz_get_si __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_get_str __gmpz_get_str
__GMP_DECLSPEC char *mpz_get_str __GMP_PROTO((char *, int, mpz_srcptr));
#define mpz_get_ui __gmpz_get_ui
#if __GMP_INLINE_PROTOTYPES || defined(__GMP_FORCE_mpz_get_ui)
__GMP_DECLSPEC mpir_ui mpz_get_ui __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#endif
...
__GMP_DECLSPEC mp_bitcnt_t mpz_hamdist __GMP_PROTO((mpz_srcptr, mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int mpz_jacobi __GMP_PROTO((mpz_srcptr,
                                           mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
#define mpz_kronecker mpz_jacobi /* alias */
#define mpz_kronecker_si __gmpz_kronecker_si
__GMP_DECLSPEC int mpz_kronecker_si __GMP_PROTO((mpz_srcptr,
                                                 mpir_si)) __GMP_ATTRIBUTE_PURE;
#define mpz_kronecker_ui __gmpz_kronecker_ui
__GMP_DECLSPEC int mpz_kronecker_ui __GMP_PROTO((mpz_srcptr,
                                                 mpir_ui)) __GMP_ATTRIBUTE_PURE;
#define mpz_si_kronecker __gmpz_si_kronecker
__GMP_DECLSPEC int
    mpz_si_kronecker __GMP_PROTO((mpir_si, mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
#define mpz_ui_kronecker __gmpz_ui_kronecker
__GMP_DECLSPEC int
    mpz_ui_kronecker __GMP_PROTO((mpir_ui, mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int mpz_millerrabin __GMP_PROTO((mpz_srcptr,
                                                int)) __GMP_ATTRIBUTE_PURE;
#define mpz_miller_rabin __gmpz_miller_rabin
__GMP_DECLSPEC int mpz_miller_rabin
    __GMP_PROTO((mpz_srcptr, int, gmp_randstate_t)) __GMP_ATTRIBUTE_PURE;
#define mpz_mod __gmpz_mod
__GMP_DECLSPEC void mpz_mod __GMP_PROTO((mpz_ptr, mpz_srcptr, mpz_srcptr));
#define mpz_mod_ui mpz_fdiv_r_ui /* same as fdiv_r because divisor unsigned */
#define __GMP_MPZ_MUL_MIN_ALLOC(x, y, z)                                       \
  (__GMP_ABS(y->_mp_size) + __GMP_ABS(z->_mp_size) + 1)
#define mpz_mul __gmpz_mul
__GMP_DECLSPEC void mpz_mul __GMP_PROTO((mpz_ptr, mpz_srcptr, mpz_srcptr));
#define mpz_mul_2exp __gmpz_mul_2exp
__GMP_DECLSPEC void mpz_mul_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                              mp_bitcnt_t));
#define __GMP_MPZ_MUL_SI_MIN_ALLOC(x, y, z)                                    \
  (__GMP_ABS(y->_mp_size) + (GMP_BITS_PER_UI - 1) / GMP_NUMB_BITS + 1)
#define mpz_mul_si __gmpz_mul_si
__GMP_DECLSPEC void mpz_mul_si __GMP_PROTO((mpz_ptr, mpz_srcptr, mpir_si));
#define __GMP_MPZ_MUL_UI_MIN_ALLOC(x, y, z)                                    \
  (__GMP_ABS(y->_mp_size) + (GMP_BITS_PER_UI - 1) / GMP_NUMB_BITS + 1)
...
__GMP_DECLSPEC void mpz_next_prime_candidate __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                          gmp_randstate_t));
...
__GMP_DECLSPEC int
    mpz_perfect_power_p __GMP_PROTO((mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
#define mpz_perfect_square_p __gmpz_perfect_square_p
#if __GMP_INLINE_PROTOTYPES || defined(__GMP_FORCE_mpz_perfect_square_p)
__GMP_DECLSPEC int
    mpz_perfect_square_p __GMP_PROTO((mpz_srcptr)) __GMP_ATTRIBUTE_PURE;
#endif
...
__GMP_DECLSPEC void mpz_powm_ui __GMP_PROTO((mpz_ptr, mpz_srcptr, mpir_ui,
                                             mpz_srcptr));
#define mpz_probab_prime_p __gmpz_probab_prime_p
__GMP_DECLSPEC int mpz_probab_prime_p __GMP_PROTO((mpz_srcptr,
                                                   int)) __GMP_ATTRIBUTE_PURE;
#define mpz_probable_prime_p __gmpz_probable_prime_p
__GMP_DECLSPEC int mpz_probable_prime_p __GMP_PROTO((mpz_srcptr,
                                                     gmp_randstate_t, int,
                                                     mpir_ui));
#define mpz_likely_prime_p __gmpz_likely_prime_p
__GMP_DECLSPEC int mpz_likely_prime_p __GMP_PROTO((mpz_srcptr, gmp_randstate_t,
                                                   mpir_ui));
#define mpz_realloc2 __gmpz_realloc2
__GMP_DECLSPEC void mpz_realloc2 __GMP_PROTO((mpz_ptr, mp_bitcnt_t));
#define mpz_remove __gmpz_remove
__GMP_DECLSPEC mp_bitcnt_t mpz_remove __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                   mpz_srcptr));
...
__GMP_DECLSPEC void mpz_rootrem __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                             mpir_ui));
#define mpz_rrandomb __gmpz_rrandomb
__GMP_DECLSPEC void mpz_rrandomb __GMP_PROTO((mpz_ptr, gmp_randstate_t,
                                              mp_bitcnt_t));
#define mpz_scan0 __gmpz_scan0
__GMP_DECLSPEC mp_bitcnt_t mpz_scan0 __GMP_PROTO((mpz_srcptr, mp_bitcnt_t))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpz_scan1 __gmpz_scan1
__GMP_DECLSPEC mp_bitcnt_t mpz_scan1 __GMP_PROTO((mpz_srcptr, mp_bitcnt_t))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
#endif
#define __GMP_MPZ_SET_SI_MIN_ALLOC(x, y)                                       \
  (1 + (GMP_BITS_PER_UI - 1) / GMP_NUMB_BITS)
...
#define __GMP_MPZ_SET_UI_MIN_ALLOC(x, y)                                       \
  (1 + (GMP_BITS_PER_UI - 1) / GMP_NUMB_BITS)
...
__GMP_DECLSPEC size_t mpz_size __GMP_PROTO((mpz_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#endif
...
__GMP_DECLSPEC mpir_ui mpz_tdiv_ui __GMP_PROTO((mpz_srcptr,
                                                mpir_ui)) __GMP_ATTRIBUTE_PURE;
#define mpz_tdiv_q __gmpz_tdiv_q
__GMP_DECLSPEC void mpz_tdiv_q __GMP_PROTO((mpz_ptr, mpz_srcptr, mpz_srcptr));
#define mpz_tdiv_q_2exp __gmpz_tdiv_q_2exp
__GMP_DECLSPEC void mpz_tdiv_q_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                 mp_bitcnt_t));
#define mpz_tdiv_q_ui __gmpz_tdiv_q_ui
__GMP_DECLSPEC mpir_ui mpz_tdiv_q_ui __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                  mpir_ui));
#define mpz_tdiv_qr __gmpz_tdiv_qr
__GMP_DECLSPEC void mpz_tdiv_qr __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                             mpz_srcptr));
#define mpz_tdiv_qr_ui __gmpz_tdiv_qr_ui
__GMP_DECLSPEC mpir_ui mpz_tdiv_qr_ui __GMP_PROTO((mpz_ptr, mpz_ptr, mpz_srcptr,
                                                   mpir_ui));
#define mpz_tdiv_r __gmpz_tdiv_r
__GMP_DECLSPEC void mpz_tdiv_r __GMP_PROTO((mpz_ptr, mpz_srcptr, mpz_srcptr));
#define mpz_tdiv_r_2exp __gmpz_tdiv_r_2exp
__GMP_DECLSPEC void mpz_tdiv_r_2exp __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                 mp_bitcnt_t));
#define mpz_tdiv_r_ui __gmpz_tdiv_r_ui
__GMP_DECLSPEC mpir_ui mpz_tdiv_r_ui __GMP_PROTO((mpz_ptr, mpz_srcptr,
                                                  mpir_ui));
#define mpz_tstbit __gmpz_tstbit
__GMP_DECLSPEC int mpz_tstbit __GMP_PROTO((mpz_srcptr, mp_bitcnt_t))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int mpq_cmp __GMP_PROTO((mpq_srcptr,
                                        mpq_srcptr)) __GMP_ATTRIBUTE_PURE;
#define _mpq_cmp_si __gmpq_cmp_si
__GMP_DECLSPEC int _mpq_cmp_si __GMP_PROTO((mpq_srcptr, mpir_si,
                                            mpir_ui)) __GMP_ATTRIBUTE_PURE;
#define _mpq_cmp_ui __gmpq_cmp_ui
__GMP_DECLSPEC int _mpq_cmp_ui __GMP_PROTO((mpq_srcptr, mpir_ui,
                                            mpir_ui)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC void mpq_div_2exp __GMP_PROTO((mpq_ptr, mpq_srcptr,
                                              mp_bitcnt_t));
...
__GMP_DECLSPEC void mpq_mul_2exp __GMP_PROTO((mpq_ptr, mpq_srcptr,
                                              mp_bitcnt_t));
...
__GMP_DECLSPEC int mpf_cmp __GMP_PROTO((mpf_srcptr, mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_cmp_d __gmpf_cmp_d
__GMP_DECLSPEC int mpf_cmp_d __GMP_PROTO((mpf_srcptr,
                                          double)) __GMP_ATTRIBUTE_PURE;
#define mpf_cmp_si __gmpf_cmp_si
__GMP_DECLSPEC int mpf_cmp_si __GMP_PROTO((mpf_srcptr, mpir_si))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_cmp_ui __gmpf_cmp_ui
__GMP_DECLSPEC int mpf_cmp_ui __GMP_PROTO((mpf_srcptr, mpir_ui))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_div __gmpf_div
__GMP_DECLSPEC void mpf_div __GMP_PROTO((mpf_ptr, mpf_srcptr, mpf_srcptr));
#define mpf_div_2exp __gmpf_div_2exp
__GMP_DECLSPEC void mpf_div_2exp __GMP_PROTO((mpf_ptr, mpf_srcptr,
                                              mp_bitcnt_t));
...
__GMP_DECLSPEC int mpf_eq __GMP_PROTO((mpf_srcptr, mpf_srcptr,
                                       mp_bitcnt_t)) __GMP_ATTRIBUTE_PURE;
#define mpf_fits_sint_p __gmpf_fits_sint_p
__GMP_DECLSPEC int mpf_fits_sint_p __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_si_p __gmpf_fits_si_p
__GMP_DECLSPEC int
    mpf_fits_si_p __GMP_PROTO((mpf_srcptr)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_slong_p __gmpf_fits_slong_p
__GMP_DECLSPEC int mpf_fits_slong_p __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_sshort_p __gmpf_fits_sshort_p
__GMP_DECLSPEC int mpf_fits_sshort_p __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_uint_p __gmpf_fits_uint_p
__GMP_DECLSPEC int mpf_fits_uint_p __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_ui_p __gmpf_fits_ui_p
__GMP_DECLSPEC int
    mpf_fits_ui_p __GMP_PROTO((mpf_srcptr)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_ulong_p __gmpf_fits_ulong_p
__GMP_DECLSPEC int mpf_fits_ulong_p __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_fits_ushort_p __gmpf_fits_ushort_p
__GMP_DECLSPEC int mpf_fits_ushort_p __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC mp_bitcnt_t mpf_get_default_prec __GMP_PROTO((void))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_get_prec __gmpf_get_prec
__GMP_DECLSPEC mp_bitcnt_t mpf_get_prec __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_get_si __gmpf_get_si
__GMP_DECLSPEC mpir_si mpf_get_si __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_get_str __gmpf_get_str
__GMP_DECLSPEC char *mpf_get_str __GMP_PROTO((char *, mp_exp_t *, int, size_t,
                                              mpf_srcptr));
#define mpf_get_ui __gmpf_get_ui
__GMP_DECLSPEC mpir_ui mpf_get_ui __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC int
    mpf_integer_p __GMP_PROTO((mpf_srcptr)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpf_mul __gmpf_mul
__GMP_DECLSPEC void mpf_mul __GMP_PROTO((mpf_ptr, mpf_srcptr, mpf_srcptr));
#define mpf_mul_2exp __gmpf_mul_2exp
__GMP_DECLSPEC void mpf_mul_2exp __GMP_PROTO((mpf_ptr, mpf_srcptr,
                                              mp_bitcnt_t));
...
__GMP_DECLSPEC void mpf_rrandomb __GMP_PROTO((mpf_ptr, gmp_randstate_t,
                                              mp_size_t, mp_exp_t));
...
__GMP_DECLSPEC void
    mpf_set_default_prec __GMP_PROTO((mp_bitcnt_t)) __GMP_NOTHROW;
#define mpf_set_prec __gmpf_set_prec
__GMP_DECLSPEC void mpf_set_prec __GMP_PROTO((mpf_ptr, mp_bitcnt_t));
#define mpf_set_prec_raw __gmpf_set_prec_raw
__GMP_DECLSPEC void mpf_set_prec_raw __GMP_PROTO((mpf_ptr,
                                                  mp_bitcnt_t)) __GMP_NOTHROW;
...
__GMP_DECLSPEC size_t mpf_size __GMP_PROTO((mpf_srcptr))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC void mpf_urandomb __GMP_PROTO((mpf_t, gmp_randstate_t,
                                              mp_bitcnt_t));
...
__GMP_DECLSPEC mp_limb_t mpn_addmul_1 __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                   mp_limb_t));
...
__GMP_DECLSPEC int mpn_mulmod_2expp1 __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                                  int, mpir_ui, mp_ptr));
#define mpn_mulmod_2expm1 __MPN(mulmod_2expm1)
__GMP_DECLSPEC void mpn_mulmod_2expm1 __GMP_PROTO((mp_ptr, mp_ptr, mp_ptr,
                                                   mpir_ui, mp_ptr));
...
__GMP_DECLSPEC void mpn_redc_1 __GMP_PROTO((mp_ptr, mp_ptr, mp_srcptr,
                                            mp_size_t, mp_limb_t);)
#define mpn_redc_2 __MPN(redc_2)
    __GMP_DECLSPEC void mpn_redc_2
    __GMP_PROTO((mp_ptr, mp_ptr, mp_srcptr, mp_size_t, mp_srcptr));
#define mpn_redc_n __MPN(redc_n)
__GMP_DECLSPEC void mpn_redc_n __GMP_PROTO((mp_ptr, mp_ptr, mp_srcptr,
                                            mp_size_t, mp_srcptr));
...
__GMP_DECLSPEC mp_limb_t mpn_divrem_1 __GMP_PROTO((mp_ptr, mp_size_t, mp_srcptr,
                                                   mp_size_t, mp_limb_t));
#define mpn_divrem_2 __MPN(divrem_2)
__GMP_DECLSPEC mp_limb_t mpn_divrem_2 __GMP_PROTO((mp_ptr, mp_size_t, mp_ptr,
                                                   mp_size_t, mp_srcptr));
#define mpn_invert __MPN(invert)
__GMP_DECLSPEC void mpn_invert __GMP_PROTO((mp_ptr xp, mp_srcptr ap,
                                            mp_size_t n));
#define mpn_sb_divappr_q __MPN(sb_divappr_q)
__GMP_DECLSPEC mp_limb_t mpn_sb_divappr_q
    __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t dn,
                 mp_limb_t dip));
#define mpn_dc_bdiv_q_n __MPN(dc_bdiv_q_n)
__GMP_DECLSPEC void
    mpn_dc_bdiv_q_n __GMP_PROTO((mp_ptr qp, mp_ptr wp, mp_ptr np, mp_srcptr dp,
                                 mp_size_t n, mp_limb_t dinv, mp_ptr scratch));
#define mpn_inv_divappr_q_n __MPN(inv_divappr_q_n)
__GMP_DECLSPEC mp_limb_t mpn_inv_divappr_q_n __GMP_PROTO(
    (mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t n, mp_srcptr dip));
#define mpn_dc_divappr_q __MPN(dc_divappr_q)
__GMP_DECLSPEC mp_limb_t mpn_dc_divappr_q
    __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t n,
                 mp_limb_t dinv));
#define mpn_dc_div_q __MPN(dc_div_q)
__GMP_DECLSPEC mp_limb_t mpn_dc_div_q __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                   mp_size_t nn, mp_srcptr dp,
                                                   mp_size_t dn,
                                                   mp_limb_t dinv));
#define mpn_inv_divappr_q __MPN(inv_divappr_q)
__GMP_DECLSPEC mp_limb_t mpn_inv_divappr_q
    __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_size_t nn, mp_srcptr dp, mp_size_t n,
                 mp_srcptr dinv));
#define mpn_inv_div_q __MPN(inv_div_q)
__GMP_DECLSPEC mp_limb_t mpn_inv_div_q __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                    mp_size_t nn, mp_srcptr dp,
                                                    mp_size_t dn,
                                                    mp_srcptr dinv));
#define mpn_inv_div_qr __MPN(inv_div_qr)
__GMP_DECLSPEC mp_limb_t mpn_inv_div_qr __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                     mp_size_t nn, mp_srcptr dp,
                                                     mp_size_t dn,
                                                     mp_srcptr dinv));
#define mpn_inv_div_qr_n __MPN(inv_div_qr_n)
__GMP_DECLSPEC mp_limb_t mpn_inv_div_qr_n __GMP_PROTO(
    (mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t dn, mp_srcptr dinv));
#define mpn_dc_div_qr __MPN(dc_div_qr)
__GMP_DECLSPEC mp_limb_t mpn_dc_div_qr __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                    mp_size_t nn, mp_srcptr dp,
                                                    mp_size_t dn,
                                                    mp_limb_t dinv));
#define mpn_dc_div_qr_n __MPN(dc_div_qr_n)
__GMP_DECLSPEC mp_limb_t mpn_dc_div_qr_n __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                      mp_srcptr dp, mp_size_t n,
                                                      mp_limb_t dinv,
                                                      mp_ptr tp));
#define mpn_sb_div_q __MPN(sb_div_q)
__GMP_DECLSPEC mp_limb_t mpn_sb_div_q __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                   mp_size_t nn, mp_srcptr dp,
                                                   mp_size_t dn,
                                                   mp_limb_t dinv));
#define mpn_sb_bdiv_q __MPN(sb_bdiv_q)
__GMP_DECLSPEC void mpn_sb_bdiv_q __GMP_PROTO((mp_ptr qp, mp_ptr wp, mp_ptr np,
                                               mp_size_t nn, mp_srcptr dp,
                                               mp_size_t dn, mp_limb_t dinv));
#define mpn_dc_bdiv_q __MPN(dc_bdiv_q)
__GMP_DECLSPEC void mpn_dc_bdiv_q __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                               mp_size_t nn, mp_srcptr dp,
                                               mp_size_t dn, mp_limb_t dinv));
#define mpn_dc_bdiv_qr __MPN(dc_bdiv_qr)
__GMP_DECLSPEC mp_limb_t mpn_dc_bdiv_qr __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                     mp_size_t nn, mp_srcptr dp,
                                                     mp_size_t dn,
                                                     mp_limb_t dinv));
#define mpn_dc_bdiv_qr_n __MPN(dc_bdiv_qr_n)
__GMP_DECLSPEC mp_limb_t mpn_dc_bdiv_qr_n
    __GMP_PROTO((mp_ptr qp, mp_ptr np, mp_srcptr dp, mp_size_t n,
                 mp_limb_t dinv, mp_ptr tp));
#define mpn_sb_div_qr __MPN(sb_div_qr)
__GMP_DECLSPEC mp_limb_t mpn_sb_div_qr __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                    mp_size_t nn, mp_srcptr dp,
                                                    mp_size_t dn,
                                                    mp_limb_t dinv));
#define mpn_sb_bdiv_qr __MPN(sb_bdiv_qr)
__GMP_DECLSPEC mp_limb_t mpn_sb_bdiv_qr __GMP_PROTO((mp_ptr qp, mp_ptr np,
                                                     mp_size_t nn, mp_srcptr dp,
                                                     mp_size_t dn,
                                                     mp_limb_t dinv));
#define mpn_tdiv_q __MPN(tdiv_q)
__GMP_DECLSPEC void mpn_tdiv_q __GMP_PROTO((mp_ptr qp, mp_srcptr np,
                                            mp_size_t nn, mp_srcptr dp,
                                            mp_size_t dn));
#define mpn_divexact __MPN(divexact)
__GMP_DECLSPEC void mpn_divexact __GMP_PROTO((mp_ptr qp, mp_srcptr np,
                                              mp_size_t nn, mp_srcptr dp,
                                              mp_size_t dn));
#define mpn_gcd __MPN(gcd)
__GMP_DECLSPEC mp_size_t mpn_gcd __GMP_PROTO((mp_ptr, mp_ptr, mp_size_t, mp_ptr,
                                              mp_size_t));
#define mpn_gcd_1 __MPN(gcd_1)
__GMP_DECLSPEC mp_limb_t mpn_gcd_1
    __GMP_PROTO((mp_srcptr, mp_size_t, mp_limb_t)) __GMP_ATTRIBUTE_PURE;
#define mpn_gcdext_1 __MPN(gcdext_1)
__GMP_DECLSPEC mp_limb_t mpn_gcdext_1 __GMP_PROTO((mp_limb_signed_t *,
                                                   mp_limb_signed_t *,
                                                   mp_limb_t, mp_limb_t));
...
__GMP_DECLSPEC mp_bitcnt_t mpn_hamdist __GMP_PROTO(
    (mp_srcptr, mp_srcptr, mp_size_t)) __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
#define mpn_lshift __MPN(lshift)
__GMP_DECLSPEC mp_limb_t mpn_lshift __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                 unsigned int));
#define mpn_mod_1 __MPN(mod_1)
__GMP_DECLSPEC mp_limb_t mpn_mod_1
    __GMP_PROTO((mp_srcptr, mp_size_t, mp_limb_t)) __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC mp_bitcnt_t mpn_popcount __GMP_PROTO((mp_srcptr, mp_size_t))
    __GMP_NOTHROW __GMP_ATTRIBUTE_PURE;
...
__GMP_DECLSPEC mp_limb_t mpn_preinv_mod_1 __GMP_PROTO(
...
__GMP_DECLSPEC void mpn_urandomb __GMP_PROTO((mp_ptr, gmp_randstate_t,
                                              mpir_ui));
#define mpn_urandomm __MPN(urandomm)
__GMP_DECLSPEC void mpn_urandomm __GMP_PROTO((mp_ptr, gmp_randstate_t,
                                              mp_srcptr, mp_size_t));
#define mpn_randomb __MPN(randomb)
__GMP_DECLSPEC void mpn_randomb __GMP_PROTO((mp_ptr, gmp_randstate_t,
                                             mp_size_t));
...
__GMP_DECLSPEC mp_bitcnt_t mpn_scan0 __GMP_PROTO((mp_srcptr, mp_bitcnt_t))
    __GMP_ATTRIBUTE_PURE;
#define mpn_scan1 __MPN(scan1)
__GMP_DECLSPEC mp_bitcnt_t mpn_scan1 __GMP_PROTO((mp_srcptr, mp_bitcnt_t))
    __GMP_ATTRIBUTE_PURE;
#define mpn_set_str __MPN(set_str)
__GMP_DECLSPEC mp_size_t mpn_set_str __GMP_PROTO((mp_ptr,
                                                  __gmp_const unsigned char *,
                                                  size_t, int));
...
__GMP_DECLSPEC mp_limb_t mpn_submul_1 __GMP_PROTO((mp_ptr, mp_srcptr, mp_size_t,
                                                   mp_limb_t));
...
__GMP_DECLSPEC void mpn_and_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                           mp_size_t));
#define mpn_andn_n __MPN(andn_n)
__GMP_DECLSPEC void mpn_andn_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t));
#define mpn_nand_n __MPN(nand_n)
__GMP_DECLSPEC void mpn_nand_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t));
#define mpn_ior_n __MPN(ior_n)
__GMP_DECLSPEC void mpn_ior_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                           mp_size_t));
#define mpn_iorn_n __MPN(iorn_n)
__GMP_DECLSPEC void mpn_iorn_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t));
#define mpn_nior_n __MPN(nior_n)
__GMP_DECLSPEC void mpn_nior_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t));
#define mpn_xor_n __MPN(xor_n)
__GMP_DECLSPEC void mpn_xor_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                           mp_size_t));
#define mpn_xnor_n __MPN(xnor_n)
__GMP_DECLSPEC void mpn_xnor_n __GMP_PROTO((mp_ptr, mp_srcptr, mp_srcptr,
                                            mp_size_t));
...
#ifndef mpn_sumdiff_n /* if not done with cpuvec in a fat binary of in         \
                         gmp-impl.h*/
...
__GMP_DECLSPEC void mpn_mul_fft_main __GMP_PROTO((mp_ptr r1, mp_srcptr i1,
                                                  mp_size_t n1, mp_srcptr i2,
                                                  mp_size_t n2));
#define mpn_mul_fft __MPN(mul_fft)
__GMP_DECLSPEC int mpn_mul_fft __GMP_PROTO((mp_ptr rp, mp_size_t rn,
...
__GMP_EXTERN_INLINE void mpz_abs(mpz_ptr __gmp_w, mpz_srcptr __gmp_u) {
  if (__gmp_w != __gmp_u)
...
#define __GMPZ_FITS_UTYPE_P(z, maxval)                                         \
  ...
  mp_ptr __gmp_p = z->_mp_d;                                                   \
  return (                                                                     \
      __gmp_n == 0 || (__gmp_n == 1 && __gmp_p[0] <= maxval) ||                \
...
__GMP_EXTERN_INLINE
#endif
int mpz_fits_ui_p(mpz_srcptr __gmp_z) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE
#endif
mpir_ui mpz_get_ui(mpz_srcptr __gmp_z) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpz_getlimbn(mpz_srcptr __gmp_z, mp_size_t __gmp_n) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE void mpz_neg(mpz_ptr __gmp_w, mpz_srcptr __gmp_u) {
  if (__gmp_w != __gmp_u)
    mpz_set(__gmp_w, __gmp_u);
...
__GMP_EXTERN_INLINE
#endif
mp_bitcnt_t mpz_popcount(mpz_srcptr __gmp_u) __GMP_NOTHROW {
...
__GMP_EXTERN_INLINE
#endif
size_t mpz_size(mpz_srcptr __gmp_z) __GMP_NOTHROW {
  return __GMP_ABS(__gmp_z->_mp_size);
}
#endif
/**************** mpq inlines ****************/
#if defined(__GMP_EXTERN_INLINE) && !defined(__GMP_FORCE_mpq_abs)
__GMP_EXTERN_INLINE void mpq_abs(mpq_ptr __gmp_w, mpq_srcptr __gmp_u) {
  if (__gmp_w != __gmp_u)
...
__GMP_EXTERN_INLINE void mpq_neg(mpq_ptr __gmp_w, mpq_srcptr __gmp_u) {
  if (__gmp_w != __gmp_u)
    mpq_set(__gmp_w, __gmp_u);
...
#define __GMPN_SUB(cout, wp, xp, xsize, yp, ysize)                             \
  __GMPN_AORS(                                                                 \
      cout, wp, xp, xsize, yp, ysize, mpn_sub_n,                               \
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpn_add(mp_ptr __gmp_wp, mp_srcptr __gmp_xp, mp_size_t __gmp_xsize,
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpn_add_1(mp_ptr __gmp_dst, mp_srcptr __gmp_src, mp_size_t __gmp_size,
...
__GMP_EXTERN_INLINE
#endif
int mpn_cmp(mp_srcptr __gmp_xp, mp_srcptr __gmp_yp,
            mp_size_t __gmp_size) __GMP_NOTHROW {
  int __gmp_result;
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpn_sub(mp_ptr __gmp_wp, mp_srcptr __gmp_xp, mp_size_t __gmp_xsize,
                  mp_srcptr __gmp_yp, mp_size_t __gmp_ysize) {
  mp_limb_t __gmp_c;
...
__GMP_EXTERN_INLINE
#endif
mp_limb_t mpn_sub_1(mp_ptr __gmp_dst, mp_srcptr __gmp_src, mp_size_t __gmp_size,
                    mp_limb_t __gmp_n) __GMP_NOTHROW {
  mp_limb_t __gmp_c;
...
#define mpz_cmp_ui(Z, UI)                                                      \
  (__builtin_constant_p(UI) && (UI) == 0 ? mpz_sgn(Z) : _mpz_cmp_ui(Z, UI))
